...
void main() {
  ...
  group('clinic summary preview dialog measurement', () {
    ...
    testWidgets('records exported failure when the PDF download fails', (
      ...
      final pdfButton = find.text(l10n.reviewClinicSummaryDownloadPdf);
  ...
  group('clinic summary preview dialog share flow', () {
    ...
    testWidgets('shows expiry and link-holder notice before creating', (
      ...
      await tester.tap(find.text(l10n.reviewClinicSummaryShare));
      await tester.pumpAndSettle();

      // Pre-create confirmation: expiry + anyone-with-the-link notice.
      expect(find.text(l10n.reviewShareConfirmTitle), findsOneWidget);
      expect(find.text(l10n.reviewShareConfirmExpiryHint(7)), findsOneWidget);
      expect(find.text(l10n.reviewShareConfirmNotice), findsOneWidget);
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.tap(find.text(l10n.reviewClinicSummaryShare));
        await tester.pumpAndSettle();
        await tester.tap(find.text(l10n.reviewShareConfirmAction));
        await tester.pumpAndSettle();
        ...
        expect(find.text(l10n.reviewShareCreatedTitle), findsOneWidget);
        expect(
          find.textContaining('clinic-summary/shared/abc'),
          findsOneWidget,
        );
        expect(find.text(l10n.reviewShareCopyAction), findsOneWidget);
        expect(find.text(l10n.reviewShareRevokeAction), findsOneWidget);
        ...
        await tester.tap(find.text(l10n.reviewShareCopyAction));
        await tester.pumpAndSettle();
        ...
        expect(find.text(l10n.reviewShareCopiedToast), findsOneWidget);
        await tester.pump(const Duration(milliseconds: 1900));
        await tester.pumpAndSettle();
