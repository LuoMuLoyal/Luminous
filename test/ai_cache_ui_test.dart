...
void main() {
  ...
  test('medicine detail refreshes with refresh=true on reanalyze', () async {
    ...
    final container = ProviderContainer(
      overrides: [
        ...
        detailFetchProvider.overrideWith(
          (ref) => ({String? drugCode, String? approvalNo, cancelToken}) async {
            return ApiResult<MedicineItem>(code: '1', msg: 'ok', result: item);
          },
        ),
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      container.read(safetyProvider.notifier).setMedicine(slot: 0, item: item);
