...
void main() {
  group('AuthTextField golden', () {
    testWidgets('default state', (tester) async {
      await tester.pumpWidget(
        _wrap(
          AuthTextField(controller: TextEditingController(), label: 'Email'),
        ),
      );
      await expectLater(
    ...
    testWidgets('with text', (tester) async {
      ...
      await tester.pumpWidget(
        _wrap(AuthTextField(controller: controller, label: 'Email')),
      );
      await expectLater(
        find.byType(AuthTextField),
  ...
  group('AuthPrimaryButton golden', () {
    ...
    testWidgets('disabled', (tester) async {
      await tester.pumpWidget(
        _wrap(const AuthPrimaryButton(label: 'Sign in', onPressed: null)),
      );
      await expectLater(
        find.byType(AuthPrimaryButton),
  ...
  group('AuthSectionCard golden', () {
    testWidgets('renders with child', (tester) async {
      await tester.pumpWidget(
        _wrap(const AuthSectionCard(child: Text('Card content'))),
      );
      await expectLater(
  ...
  group('AuthStatusMessage golden', () {
    testWidgets('error message', (tester) async {
      await tester.pumpWidget(
        _wrap(const AuthStatusMessage(error: 'Invalid credentials')),
      );
      await expectLater(
    ...
    testWidgets('success message', (tester) async {
      await tester.pumpWidget(
        _wrap(const AuthStatusMessage(success: 'Code sent')),
      );
      await expectLater(
        find.byType(AuthStatusMessage),
