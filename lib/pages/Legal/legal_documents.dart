...
const List<_LegalSection> _userAgreementSections = [
  _LegalSection(
    title: '1. 协议适用范围',
    body:
  ...
  _LegalSection(
    title: '3. 账号与安全',
    body: '你应妥善保管自己的登录信息，不得借用、出租或转让账号。因你主动泄露账号信息、在不安全设备登录、或未及时退出所导致的风险，由你自行承担。',
  ),
  _LegalSection(
    title: '4. 使用规范',
    body:
...
const List<_LegalSection> _privacyPolicySections = [
  _LegalSection(
    title: '1. 我们收集的信息',
    body:
  ...
  _LegalSection(
    title: '7. 联系与更新',
    body: '如果后续隐私政策发生实质更新，我们会在应用内提供新版本说明。你继续使用相关功能，即表示你已知悉并接受更新后的内容。',
  ),
];
...
class UserAgreementPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _LegalDocumentPage(
      title: '用户协议',
      summary: '请在使用 Luminous 健康助手前，先了解账号、服务边界和使用规范。',
      sections: _userAgreementSections,
    );
  }
}
...
class PrivacyPolicyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _LegalDocumentPage(
      title: '隐私政策',
      summary: '这里说明应用会收集哪些信息、如何使用，以及你后续可以如何管理。',
