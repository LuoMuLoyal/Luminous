...
class _CheckInPageState extends State<CheckInPage> {
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.fact_check_outlined, color: Color(0xFFF59E0B), size: 30),
              ),
  ...
  Widget _buildEmpty() {
    return Container(
      ...
      child: const Column(
        children: [
          Icon(Icons.event_available_outlined, size: 42, color: Color(0xFF94A3B8)),
          SizedBox(height: 10),
          Text(
            '今日暂无提醒',
            style: TextStyle(
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    item.time.trim().isEmpty ? item.title : '${item.time} ${item.title}',
                    style: const TextStyle(
                      fontSize: 15,
                      fontWeight: FontWeight.w800,
                      color: Color(0xFF0F172A),
                  ...
                  Text(
                    item.subtitle.trim().isEmpty ? '请按时完成' : item.subtitle.trim(),
                    style: const TextStyle(
                      fontSize: 12.5,
                      height: 1.4,
                      color: Color(0xFF64748B),
            ...
            FilledButton(
              onPressed: onCheckIn,
              style: FilledButton.styleFrom(
                backgroundColor: done ? const Color(0xFF94A3B8) : const Color(0xFFF59E0B),
                foregroundColor: Colors.white,
