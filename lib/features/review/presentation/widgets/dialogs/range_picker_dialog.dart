    ...
    builder: (dialogContext) => Column(
      ...
      children: [
        ...
        Column(
          ...
          children: [
            _RangeOptionTile(
              label: l10n.reviewRangeLast7Days,
            ...
            _RangeOptionTile(
              label: l10n.reviewRangeLast30Days,
...
Future<ReviewDashboardQuery?> _showMobileRangePicker(
  BuildContext context,
...
Future<ReviewDashboardQuery?> _showCalendarBottomSheet(
  BuildContext context,
  AppLocalizations l10n,
  ReviewDashboardQuery selectedQuery,
) async {
...
Future<ReviewDashboardQuery?> _showCalendarDialog(
  BuildContext context,
  AppLocalizations l10n,
  ReviewDashboardQuery selectedQuery,
) async {
