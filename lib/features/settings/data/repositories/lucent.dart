...
class LucentUserSettingsRepository implements UserSettingsRepository {
  ...
  Future<UserSettings> getSettings() async {
    ...
    return _mapSettings(requireData(response.data, operation: 'getSettings'));
  }
  ...
  Future<UserSettings> updateSettings({
    ...
    return _mapSettings(
      requireData(response.data, operation: 'updateSettings'),
    );
  }
  ...
  Future<UserSettings> enableSecurityPin(String pin) async {
    ...
    return _mapSettings(
      requireData(response.data, operation: 'enableSecurityPin'),
    );
  }
  ...
  Future<UserSettings> changeSecurityPin(String oldPin, String newPin) async {
    ...
    return _mapSettings(
      requireData(response.data, operation: 'changeSecurityPin'),
    );
  }
  ...
  Future<UserSettings> disableSecurityPin(String pin) async {
    ...
    return _mapSettings(
      requireData(response.data, operation: 'disableSecurityPin'),
    );
  }
