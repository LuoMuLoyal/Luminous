...
class KeyChangesSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (!isAvailable) {
      return ReviewSectionCard(
        ...
        title: l10n.reportReviewSectionKeyChanges,
    ...
    final rows = <Widget>[
      ...
      if (water != null)
        _numericTrendRow(
          context,
          l10n,
          title: l10n.reportReviewChangeWaterTitle,
          trend: water,
          unit: l10n.reportReviewChangeUnitMl,
        ),
      if (sleep != null)
        _numericTrendRow(
          context,
          l10n,
          title: l10n.reportReviewChangeSleepTitle,
          trend: sleep,
          unit: l10n.reportReviewChangeUnitHour,
          fractionDigits: 1,
        ),
    ];
    ...
    return ReviewSectionCard(
      ...
      title: l10n.reportReviewSectionKeyChanges,
      child: rows.isEmpty
          ? ReviewUnknownReason(reason: l10n.reportReviewReasonUnknown)
          : Column(
  ...
  Widget _outcomeTrendRow(
    ...
    return _TrendRow(
      title: l10n.reportReviewChangeOutcomeTitle,
      ...
      detail: l10n.reportReviewChangeOutcomeDetail(
  ...
  Widget _numericTrendRow(
    ...
    return _TrendRow(
      ...
      detail: l10n.reportReviewChangeNumericDetail(
