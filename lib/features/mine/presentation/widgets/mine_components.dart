...
class MineIconBadge extends StatelessWidget {
  const MineIconBadge({
    super.key,
    required this.icon,
    required this.color,
...
class MineStatusBadge extends StatelessWidget {
  const MineStatusBadge({
    super.key,
    required this.label,
    required this.color,
    required this.typography,
...
class MineTextAction extends StatelessWidget {
  const MineTextAction({
    super.key,
    required this.label,
    required this.typography,
    required this.surface,
