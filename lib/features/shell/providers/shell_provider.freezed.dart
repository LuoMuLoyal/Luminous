...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ShellState&&(identical(other.currentIndex, currentIndex) || other.currentIndex == currentIndex));
}
...
@override
String toString() {
  return 'ShellState(currentIndex: $currentIndex)';
}
...
class _ShellState implements ShellState {
  const _ShellState({this.currentIndex = 0});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ShellState&&(identical(other.currentIndex, currentIndex) || other.currentIndex == currentIndex));
}
