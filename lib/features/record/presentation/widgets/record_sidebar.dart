...
class RecordHealthBagPanel extends StatelessWidget {
  const RecordHealthBagPanel({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return RecordSectionSurface(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () =>
              showRecordToast(context, recordCopy(l10n, healthBag.titleKey)),
            ...
            children: [
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      recordCopy(l10n, healthBag.titleKey),
              ...
              const SizedBox(height: AppSpacingTokens.md),
              Text(
                recordCopy(l10n, healthBag.bodyKey),
                style: typography.bodySm.copyWith(color: surface.body),
              ),
              const SizedBox(height: AppSpacingTokens.lg),
              Text(
                recordCopy(l10n, healthBag.latestKey),
                style: typography.caption.copyWith(color: surface.body),
              ),
              const SizedBox(height: AppSpacingTokens.xs),
              Text(
                recordCopy(l10n, healthBag.nextKey),
                style: typography.caption.copyWith(color: surface.body),
              ),
            ],
          ),
