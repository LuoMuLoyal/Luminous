...
class RecordNlpDialog extends ConsumerStatefulWidget {
  const RecordNlpDialog({super.key, required this.occurredAt});

  final String occurredAt;

  @override
  ConsumerState<RecordNlpDialog> createState() => _RecordNlpDialogState();
}

class _RecordNlpDialogState extends ConsumerState<RecordNlpDialog> {
