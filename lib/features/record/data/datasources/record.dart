...
class DailyRecordRemoteDataSource {
  ...
  DailyRecordItem _toItem(lucent.DailyRecordListResponseItems item) {
    return DailyRecordItem(
      ...
      mealHeadline: _asStringOrNull(item.mealHeadline),
      mealCalorieMin: item.mealCalorieMin?.toInt(),
      mealCalorieMax: item.mealCalorieMax?.toInt(),
      mealCalorieBucket: item.mealCalorieBucket?.value,
