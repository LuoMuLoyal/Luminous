...
/// Bottom-sheet content for ending an active health event.
class EndEventSheet extends StatefulWidget {
  const EndEventSheet({
    super.key,
  ...
  @override
  State<EndEventSheet> createState() => _EndEventSheetState();
}

class _EndEventSheetState extends State<EndEventSheet> {
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                Expanded(
                  child: _OutcomeButton(
                    key: const Key('health-event-end-outcome-improved'),
            ...
            Row(
              ...
              children: [
                FButton(
                  key: const Key('health-event-end-cancel'),
