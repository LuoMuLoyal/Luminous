...
- [0002](0002-gorouter-navigation.md)
  ...
  - Status: accepted
  - Date: 2026-05-30
- [0003](0003-riverpod-generator-and-auth-guard.md)
  - Title: riverpod_generator 与 Auth-Guarded Provider 工厂
  - Status: accepted
  - Date: 2026-07-10
- [0004](0004-network-layer-separation.md)
  - Title: 网络层职责分离 — LucentDioClient 拆分与 API 访问简化
  - Status: accepted
  - Date: 2026-07-10
- [0005](0005-result-type-and-error-handling.md)
  - Title: Result 类型与统一错误处理（fpdart + LucentFailure；旧自建 Result 方案已取代）
  - Status: accepted (amended 2026-08-18)
  - Date: 2026-07-10
- [0006](0006-local-persistence-drift.md)
  - Title: 本地持久化与离线策略 — Drift
  - Status: accepted
  - Date: 2026-07-10
- [0007](0007-event-led-sparse-record-product-loop.md)
