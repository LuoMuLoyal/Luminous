...
- After the 2026-07-02 record page/detail pass, the remaining record old-theme debt is narrower: desktop `record_dashboard_view.dart` still instantiates old typography/surface for deeper desktop sections, and the main leftovers now live in `record_sidebar.dart`, `record_summary_grid.dart`, `record_timeline.dart`, `record_quick_actions.dart`, and related shared section helpers rather than the record page/detail entry surfaces.
