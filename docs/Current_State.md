...
- Still mock/static or planned: live reminders, Mine campus-service contracts, Settings privacy/reminder/export/help/about contracts, Report insights/export data, Medicine OCR/barcode scanning and richer safety-engine data, smart devices, family profiles, push notifications, richer record analytics, and other low-frequency utilities that do not yet have a north-star tab home.
