...
- After the 2026-07-02 record desktop-section pass, the remaining record old-theme debt is concentrated in the smaller leftover shells and dialogs, mainly `record_quick_actions.dart`, `record_week_strip.dart`, `record_nlp_dialog.dart`, `record_voice_entry_dialog.dart`, and `record_ocr_entry_dialog.dart`.
