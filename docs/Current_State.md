...
- Medicine: active current-medicine drugbox, reminder-derived next dose, panel-backed medication actions, same-day taken/skipped dose logs, risk-check entry, safety explanations, and pregnancy/lactation/special-group medication safety conditions. Medicine no longer surfaces a local medication-report shortcut.
