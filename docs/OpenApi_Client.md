...
- Re-generated on 2026-06-06 after Lucent added `GET /api/v1/environment/snapshot`. Lucent export currently reports **36 paths / 100 schemas**. The generated package now includes `EnvironmentApi`, `EnvironmentSnapshotDto`, and related indicator DTOs.
