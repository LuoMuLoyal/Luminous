...
- Lucent 跨仓修复待重做：2026-08-31 提交 f7320697 被并行会话 reset 丢弃（README Product_Vision、howto sync-openapi-client OpenApi_Client、glossary Product_Brainstorm 三处指向归档的路径修正）；待 Lucent 仓稳定后重做
