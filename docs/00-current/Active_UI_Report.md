...
Last updated: 2026-08-21（增量审查修复：review_history _pendingCursor 重置 + build 副作用移至 lifecycle + review_detail l10n null guard + router 路由参数安全解包 + lucent_ai_summary 未知枚举映射日志 + clinic_summary _sectionSelected 一致性）
