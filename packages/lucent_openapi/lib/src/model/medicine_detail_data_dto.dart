...
class MedicineDetailDataDto {
  ...
  final MedicineDetailDataDtoDetail detail;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is MedicineDetailDataDto &&
      other.id == id &&
  ...
  factory MedicineDetailDataDto.fromJson(Map<String, dynamic> json) => _$MedicineDetailDataDtoFromJson(json);
