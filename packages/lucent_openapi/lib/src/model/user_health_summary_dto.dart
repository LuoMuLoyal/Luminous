...
class UserHealthSummaryDto {
  ...
  final List<String> missingCoreProfileFields;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is UserHealthSummaryDto &&
      other.age == age &&
  ...
  factory UserHealthSummaryDto.fromJson(Map<String, dynamic> json) => _$UserHealthSummaryDtoFromJson(json);
