...
class UserCurrentMedicineItemDto {
  ...
  final String updatedAt;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is UserCurrentMedicineItemDto &&
      other.id == id &&
  ...
  factory UserCurrentMedicineItemDto.fromJson(Map<String, dynamic> json) => _$UserCurrentMedicineItemDtoFromJson(json);
