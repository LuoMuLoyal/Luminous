...
class AssistantConversationSummaryDto {
  ...
  final AssistantConversationSummaryDtoStatusEnum status;
  ...
  bool operator ==(Object other) =>
      ...
      other is AssistantConversationSummaryDto &&
          other.id == id &&
          other.title == title &&
          other.status == status &&
  ...
  factory AssistantConversationSummaryDto.fromJson(Map<String, dynamic> json) =>
...
enum AssistantConversationSummaryDtoStatusEnum {
  ...
  const AssistantConversationSummaryDtoStatusEnum(this.value);
