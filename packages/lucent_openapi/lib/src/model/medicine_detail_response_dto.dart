...
class MedicineDetailResponseDto {
  ...
  final MedicineDetailDataDto data;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is MedicineDetailResponseDto &&
      other.code == code &&
  ...
  factory MedicineDetailResponseDto.fromJson(Map<String, dynamic> json) => _$MedicineDetailResponseDtoFromJson(json);
