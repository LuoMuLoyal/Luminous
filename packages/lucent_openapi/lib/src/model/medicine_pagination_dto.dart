...
class MedicinePaginationDto {
  ...
  final num totalPages;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is MedicinePaginationDto &&
      other.page == page &&
  ...
  factory MedicinePaginationDto.fromJson(Map<String, dynamic> json) => _$MedicinePaginationDtoFromJson(json);
