...
class ReportSummaryDataDto {
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: ReportSummaryDataDtoRangeEnum.unknownDefaultOpenApi,
  )
  final ReportSummaryDataDtoRangeEnum range;
  ...
  Map<String, dynamic> toJson() => _$ReportSummaryDataDtoToJson(this);
...
enum ReportSummaryDataDtoRangeEnum {
  ...
  const ReportSummaryDataDtoRangeEnum(this.value);
