...
class MedicineSearchResponseDto {
  ...
  final MedicineSearchMetaDto meta;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is MedicineSearchResponseDto &&
      other.code == code &&
  ...
  factory MedicineSearchResponseDto.fromJson(Map<String, dynamic> json) => _$MedicineSearchResponseDtoFromJson(json);
