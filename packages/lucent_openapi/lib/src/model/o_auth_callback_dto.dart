...
class OAuthCallbackDto {
  ...
  OAuthCallbackDto({required this.code, required this.state});
  ...
  bool operator ==(Object other) =>
      ...
      other is OAuthCallbackDto && other.code == code && other.state == state;
  ...
  Map<String, dynamic> toJson() => _$OAuthCallbackDtoToJson(this);
