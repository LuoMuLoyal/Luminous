...
class HealthApi {
  ...
  Future<Response<HealthResponseDto>> appControllerGetDeepHealthV1({ 
    ...
    final _path = r'/api/v1/health/deep';
...
_responseData = rawData == null ? null : deserialize<HealthResponseDto, HealthResponseDto>(rawData, 'HealthResponseDto', growable: true);
...
_responseData = rawData == null ? null : deserialize<HealthResponseDto, HealthResponseDto>(rawData, 'HealthResponseDto', growable: true);
  ...
  Future<Response<HealthResponseDto>> appControllerGetLiveHealthV1({ 
    ...
    final _path = r'/api/v1/health/live';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<HealthResponseDto, HealthResponseDto>(rawData, 'HealthResponseDto', growable: true);
  ...
  Future<Response<HealthResponseDto>> appControllerGetReadyHealthV1({ 
    ...
    final _path = r'/api/v1/health/ready';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
