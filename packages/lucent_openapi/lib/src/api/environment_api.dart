...
class EnvironmentApi {
  ...
  Future<Response<EnvironmentSnapshotResponseDto>> environmentControllerGetSnapshotV1({ 
    num? lat,
    num? lon,
    ...
    final _path = r'/api/v1/environment/snapshot';
...
_responseData = rawData == null ? null : deserialize<EnvironmentSnapshotResponseDto, EnvironmentSnapshotResponseDto>(rawData, 'EnvironmentSnapshotResponseDto', growable: true);
