...
class MedicineRemindersApi {
  ...
  const MedicineRemindersApi(this._dio);
  ...
  Future<Response<MedicineReminderResponseDto>> medicineRemindersControllerCreateV1({ 
...
_responseData = rawData == null ? null : deserialize<MedicineReminderResponseDto, MedicineReminderResponseDto>(rawData, 'MedicineReminderResponseDto', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MedicineReminderListResponseDto>> medicineRemindersControllerListV1({ 
    String? activeOnly,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<MedicineReminderListResponseDto, MedicineReminderListResponseDto>(rawData, 'MedicineReminderListResponseDto', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [MedicineReminderResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MedicineReminderResponseDto>> medicineRemindersControllerUpdateV1({ 
    required String id,
