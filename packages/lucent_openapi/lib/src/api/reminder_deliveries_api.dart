...
class ReminderDeliveriesApi {
  ...
  const ReminderDeliveriesApi(this._dio);
  ...
  Future<Response<ReminderDeliveryListResponseDto>> reminderDeliveriesControllerListV1({ 
    String? date,
    String? limit,
...
_responseData = rawData == null ? null : deserialize<ReminderDeliveryListResponseDto, ReminderDeliveryListResponseDto>(rawData, 'ReminderDeliveryListResponseDto', growable: true);
