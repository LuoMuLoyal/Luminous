...
_responseData = rawData == null ? null : deserialize<DataExportRequestResponseDto, DataExportRequestResponseDto>(rawData, 'DataExportRequestResponseDto', growable: true);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DataExportLatestResponseDto>> dataExportControllerGetLatestRequestV1({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<DataExportLatestResponseDto, DataExportLatestResponseDto>(rawData, 'DataExportLatestResponseDto', growable: true);
