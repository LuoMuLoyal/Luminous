...
class UserSettingsApi {
  ...
  Future<Response<UserSettingsResponseDto>> userSettingsControllerGetSettingsV1({ 
...
_responseData = rawData == null ? null : deserialize<UserSettingsResponseDto, UserSettingsResponseDto>(rawData, 'UserSettingsResponseDto', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [UserSettingsResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserSettingsResponseDto>> userSettingsControllerUpdateSettingsV1({ 
