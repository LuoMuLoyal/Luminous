...
> MedicineDetailResponseDto medicinesControllerGetDetailV1(id, source_)
...
try {
    final response = api.medicinesControllerGetDetailV1(id, source_);
    print(response);
...
> MedicineSearchResponseDto medicinesControllerSearchV1(source_, q, page, pageSize)
...
try {
    final response = api.medicinesControllerSearchV1(source_, q, page, pageSize);
    print(response);
} on DioException catch (e) {
