...
- Files:
  ...
  - remaining feature leftovers still leaning on the bridge, mainly `lib/features/auth/presentation/widgets/*` plus a few formatter/helper files that still encode `AppThemeSurface`
- Action:
