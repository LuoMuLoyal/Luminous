...
### 2-2. AvatarUploader 错误分类与防御位置【09-12 W-2 + W-5】P1·S
...
### 2-3. 路由守卫 redirect 零覆盖【09-11 S-2】P1·M
...
### 2-5. legacy profile_edit 页退役【09-14 S1】P1·M
...
- **Wave 1（P1 主干）**：2-1 → 2-2 → 2-4 → 2-3 → 2-5。每项落地即跑对应目录 `flutter test`。
