...
void main() {
  ...
  testWidgets(
    'sleep create sends correct payload with wake-date convention',
    (tester) async {
      ...
      // Tap the sleep quick action to open the create page.
...
Future<void> _enterTimeAndConfirm(
  ...
  await pumpUntilFound(tester, dialogFields.first, timeout: const Duration(seconds: 5));
