...
///
/// By default the ONNX model files are **not** bundled in the APK. They must
/// be provided via [modelPaths] when calling [init]. The host app is responsible
/// for downloading the model files to the device's file system before initialising
/// the engine.
///
/// Usage:
/// ```dart
...
///     detModelPath: '/path/to/det/inference.onnx',
///     recModelPath: '/path/to/rec/inference.onnx',
///     recConfigPath: '/path/to/rec/inference.yml',
///   ),
/// );
...
export 'src/paddle_ocr_config.dart'
    show PaddleOcrConfig, EngineConfig, ModelPaths;
...
class PaddleOcr {
  ...
  /// [modelPaths] specifies the file system paths to the ONNX model files.
  /// The host app must download the model files before calling this method.
  Future<void> init({
