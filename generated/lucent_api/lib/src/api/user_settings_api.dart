...
class UserSettingsApi {
  ...
  const UserSettingsApi(this._dio);
  ...
  userSettingsControllerChangeSecurityPinV1({
    ...
    final _path = r'/api/v1/user/settings/security-pin/change';
    ...
    try {
      _bodyData = jsonEncode(changeSecurityPinDto);
  ...
  userSettingsControllerDisableSecurityPinV1({
    ...
    final _path = r'/api/v1/user/settings/security-pin/disable';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
    ...
    try {
      _bodyData = jsonEncode(disableSecurityPinDto);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  userSettingsControllerEnableSecurityPinV1({
    ...
    final _path = r'/api/v1/user/settings/security-pin';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
    ...
    try {
      _bodyData = jsonEncode(enableSecurityPinDto);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SecurityPinElevationResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  ...
  userSettingsControllerVerifySecurityPinV1({
    ...
    final _path = r'/api/v1/user/settings/security-pin/verify';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
    ...
    try {
      _bodyData = jsonEncode(verifySecurityPinDto);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
    ...
    SecurityPinElevationResponseDto? _responseData;
    ...
    try {
      ...
      _responseData = rawData == null
          ...
          : deserialize<
              ...
              SecurityPinElevationResponseDto
            >(rawData, 'SecurityPinElevationResponseDto', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<SecurityPinElevationResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
