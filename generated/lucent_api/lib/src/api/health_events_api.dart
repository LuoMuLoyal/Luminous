...
class HealthEventsApi {
  ...
  const HealthEventsApi(this._dio);
  ...
  Future<Response<HealthEventItemDto>> healthEventsControllerActiveV1({
    ...
    final _path = r'/api/v1/user/health-events/active';
  ...
  Future<Response<HealthEventResponseDto>> healthEventsControllerCreateV1({
    ...
    final _path = r'/api/v1/user/health-events';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
  ...
  Future<Response<HealthEventResponseDto>> healthEventsControllerEndV1({
    ...
    final _path = r'/api/v1/user/health-events/{id}/end'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  Future<Response<HealthEventResponseDto>> healthEventsControllerGetV1({
    ...
    final _path = r'/api/v1/user/health-events/{id}'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  healthEventsControllerUpsertCheckInV1({
    ...
    final _path = r'/api/v1/user/health-events/{id}/check-ins/{date}'
        .replaceAll(
          '{'
          r'id'
          '}',
