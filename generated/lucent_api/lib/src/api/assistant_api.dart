...
class AssistantApi {
  ...
  assistantControllerClearLatestConversationV1({
    ...
    final _path = r'/api/v1/user/assistant/latest/clear';
  ...
  /// Erase all persisted assistant memories for the user
  ///
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  assistantControllerClearMemoryV1({
    ...
    final _path = r'/api/v1/user/assistant/memory';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
  ...
  assistantControllerConfirmProposalV1({
    ...
    final _path =
        r'/api/v1/user/assistant/conversations/{conversationId}/confirm'
            .replaceAll(
              '{'
              r'conversationId'
              '}',
  ...
  /// Soft-delete one persisted assistant conversation
  ///
  ///
  /// Parameters:
  /// * [conversationId]
  ...
  assistantControllerDeleteConversationV1({
    ...
    final _path = r'/api/v1/user/assistant/conversations/{conversationId}'
        .replaceAll(
          '{'
          r'conversationId'
          '}',
  ...
  assistantControllerGetCapabilitiesV1({
    ...
    final _path = r'/api/v1/user/assistant/capabilities';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
  ...
  assistantControllerGetLatestConversationV1({
    ...
    final _path = r'/api/v1/user/assistant/latest';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
  ...
  assistantControllerListRecentConversationsV1({
    ...
    final _path = r'/api/v1/user/assistant/conversations';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
  ...
  assistantControllerOpenConversationV1({
    ...
    final _path = r'/api/v1/user/assistant/conversations/{conversationId}/open'
        .replaceAll(
          '{'
          r'conversationId'
          '}',
  ...
  Future<Response<String>> assistantControllerRegenerateLastMessageV1({
    ...
    final _path =
        r'/api/v1/user/assistant/conversations/{conversationId}/regenerate'
            .replaceAll(
              '{'
              r'conversationId'
              '}',
  ...
  /// Rename one persisted assistant conversation (title only)
  ///
  ///
  /// Parameters:
  /// * [conversationId]
  ...
  Future<Response<String>> assistantControllerStreamMessagesV1({
    ...
    final _path = r'/api/v1/user/assistant/messages/stream';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
