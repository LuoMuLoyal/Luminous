...
class LegalDocumentsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [LegalDocumentListResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LegalDocumentListResponseDto>>
  legalDocumentsControllerFindAllV1({
    String? lang,
    ...
    LegalDocumentListResponseDto? _responseData;
    ...
    try {
      ...
      _responseData = rawData == null
          ...
          : deserialize<
              ...
              LegalDocumentListResponseDto
            >(rawData, 'LegalDocumentListResponseDto', growable: true);
    ...
    return Response<LegalDocumentListResponseDto>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [LegalDocumentDetailResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LegalDocumentDetailResponseDto>>
  legalDocumentsControllerFindOneV1({
    ...
    LegalDocumentDetailResponseDto? _responseData;
    ...
    try {
      ...
      _responseData = rawData == null
          ...
          : deserialize<
              ...
              LegalDocumentDetailResponseDto
            >(rawData, 'LegalDocumentDetailResponseDto', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<LegalDocumentDetailResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
