...
class NotificationsApi {
  ...
  Future<Response<void>> notificationsControllerCreateV1({
    ...
    final _path = r'/api/v1/user/notifications';
  ...
  notificationsControllerMarkAllAsReadV1({
    ...
    final _path = r'/api/v1/user/notifications/mark-all-read';
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
  ...
  notificationsControllerMarkAsReadV1({
    ...
    final _path = r'/api/v1/user/notifications/{id}/read'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  notificationsControllerMarkAsUnreadV1({
    ...
    final _path = r'/api/v1/user/notifications/{id}/unread'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
