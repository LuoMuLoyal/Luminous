...
class MedicinesApi {
  ...
  /// Get latest medicine risk check records
  ///
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  medicinesControllerGetRiskCheckV1({
    ...
    final _path = r'/api/v1/medicines/risk-check';
    final _options = Options(
      method: r'GET',
  ...
  medicinesControllerGetSafetyTipsV1({
    ...
    final _path = r'/api/v1/medicines/safety-tips';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{'secure': <Map<String, String>>[], ...?extra},
  ...
  Future<Response<void>> medicinesControllerRecognizeStatusV1({
    ...
    final _path = r'/api/v1/medicines/recognize/status/{jobId}'.replaceAll(
      '{'
      r'jobId'
      '}',
      jobId.toString(),
