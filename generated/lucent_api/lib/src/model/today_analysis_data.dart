...
part 'today_analysis_data.g.dart';
...
class TodayAnalysisData {
  /// Returns a new [TodayAnalysisData] instance.
  TodayAnalysisData({
    required this.date,
  ...
  factory TodayAnalysisData.fromJson(Map<String, dynamic> json) =>
      _$TodayAnalysisDataFromJson(json);

  Map<String, dynamic> toJson() => _$TodayAnalysisDataToJson(this);
