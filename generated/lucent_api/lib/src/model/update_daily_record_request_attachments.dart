...
part 'update_daily_record_request_attachments.g.dart';
...
class UpdateDailyRecordRequestAttachments {
  /// Returns a new [UpdateDailyRecordRequestAttachments] instance.
  UpdateDailyRecordRequestAttachments({
    this.kind,
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        UpdateDailyRecordRequestAttachmentsKindEnum.unknownDefaultOpenApi,
  )
  final UpdateDailyRecordRequestAttachmentsKindEnum? kind;
  ...
  bool operator ==(Object other) =>
      ...
      other is UpdateDailyRecordRequestAttachments &&
          other.kind == kind &&
  ...
  factory UpdateDailyRecordRequestAttachments.fromJson(
    Map<String, dynamic> json,
  ) => _$UpdateDailyRecordRequestAttachmentsFromJson(json);

  Map<String, dynamic> toJson() =>
      _$UpdateDailyRecordRequestAttachmentsToJson(this);
...
/// Attachment kind. Defaults to \"image\".
enum UpdateDailyRecordRequestAttachmentsKindEnum {
  @JsonValue(r'image')
  image(r'image'),
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi(r'unknown_default_open_api');

  const UpdateDailyRecordRequestAttachmentsKindEnum(this.value);
