...
part 'today_analysis_read_response_dto.g.dart';
...
class TodayAnalysisReadResponseDto {
  /// Returns a new [TodayAnalysisReadResponseDto] instance.
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        TodayAnalysisReadResponseDtoStatusEnum.unknownDefaultOpenApi,
  )
  final TodayAnalysisReadResponseDtoStatusEnum status;
  ...
  bool operator ==(Object other) =>
      ...
      other is TodayAnalysisReadResponseDto &&
  ...
  factory TodayAnalysisReadResponseDto.fromJson(Map<String, dynamic> json) =>
      _$TodayAnalysisReadResponseDtoFromJson(json);

  Map<String, dynamic> toJson() => _$TodayAnalysisReadResponseDtoToJson(this);
...
enum TodayAnalysisReadResponseDtoStatusEnum {
  @JsonValue(r'empty')
  empty(r'empty'),
  @JsonValue(r'pending')
  pending(r'pending'),
  ...
  const TodayAnalysisReadResponseDtoStatusEnum(this.value);
