...
part 'medicine_detail_response_dto_detail_one_of1.g.dart';
...
class MedicineDetailResponseDtoDetailOneOf1 {
  /// Returns a new [MedicineDetailResponseDtoDetailOneOf1] instance.
  MedicineDetailResponseDtoDetailOneOf1({
    required this.kind,
  ...
  bool operator ==(Object other) =>
      ...
      other is MedicineDetailResponseDtoDetailOneOf1 &&
          other.kind == kind &&
  ...
  factory MedicineDetailResponseDtoDetailOneOf1.fromJson(
    Map<String, dynamic> json,
  ) => _$MedicineDetailResponseDtoDetailOneOf1FromJson(json);

  Map<String, dynamic> toJson() =>
      _$MedicineDetailResponseDtoDetailOneOf1ToJson(this);
