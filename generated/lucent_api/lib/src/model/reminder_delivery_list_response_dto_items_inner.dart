...
part 'reminder_delivery_list_response_dto_items_inner.g.dart';
...
class ReminderDeliveryListResponseDtoItemsInner {
  /// Returns a new [ReminderDeliveryListResponseDtoItemsInner] instance.
  ReminderDeliveryListResponseDtoItemsInner({
    required this.id,
  ...
  bool operator ==(Object other) =>
      ...
      other is ReminderDeliveryListResponseDtoItemsInner &&
          other.id == id &&
  ...
  factory ReminderDeliveryListResponseDtoItemsInner.fromJson(
    Map<String, dynamic> json,
  ) => _$ReminderDeliveryListResponseDtoItemsInnerFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ReminderDeliveryListResponseDtoItemsInnerToJson(this);
