...
part 'medicine_dose_logs_controller_create_v1_request.g.dart';
...
class MedicineDoseLogsControllerCreateV1Request {
  /// Returns a new [MedicineDoseLogsControllerCreateV1Request] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: MedicineDoseLogsControllerCreateV1RequestStatusEnum
        .unknownDefaultOpenApi,
  )
  final MedicineDoseLogsControllerCreateV1RequestStatusEnum status;
  ...
  bool operator ==(Object other) =>
      ...
      other is MedicineDoseLogsControllerCreateV1Request &&
  ...
  factory MedicineDoseLogsControllerCreateV1Request.fromJson(
    Map<String, dynamic> json,
  ) => _$MedicineDoseLogsControllerCreateV1RequestFromJson(json);

  Map<String, dynamic> toJson() =>
      _$MedicineDoseLogsControllerCreateV1RequestToJson(this);
...
enum MedicineDoseLogsControllerCreateV1RequestStatusEnum {
  @JsonValue(r'taken')
  taken(r'taken'),
  @JsonValue(r'skipped')
  skipped(r'skipped'),
  ...
  const MedicineDoseLogsControllerCreateV1RequestStatusEnum(this.value);
