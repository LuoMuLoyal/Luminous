...
part 'user_settings_response_assistant_context.g.dart';
...
class UserSettingsResponseAssistantContext {
  /// Returns a new [UserSettingsResponseAssistantContext] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is UserSettingsResponseAssistantContext &&
  ...
  factory UserSettingsResponseAssistantContext.fromJson(
    Map<String, dynamic> json,
  ) => _$UserSettingsResponseAssistantContextFromJson(json);

  Map<String, dynamic> toJson() =>
      _$UserSettingsResponseAssistantContextToJson(this);
