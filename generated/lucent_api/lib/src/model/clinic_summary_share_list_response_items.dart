...
part 'clinic_summary_share_list_response_items.g.dart';
...
class ClinicSummaryShareListResponseItems {
  /// Returns a new [ClinicSummaryShareListResponseItems] instance.
  ...
  final ClinicSummaryShareListResponseItemsScope scope;
  ...
  bool operator ==(Object other) =>
      ...
      other is ClinicSummaryShareListResponseItems &&
          other.id == id &&
  ...
  factory ClinicSummaryShareListResponseItems.fromJson(
    Map<String, dynamic> json,
  ) => _$ClinicSummaryShareListResponseItemsFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ClinicSummaryShareListResponseItemsToJson(this);
