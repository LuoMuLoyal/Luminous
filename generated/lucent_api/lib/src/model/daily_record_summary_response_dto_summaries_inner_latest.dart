...
part 'daily_record_summary_response_dto_summaries_inner_latest.g.dart';
...
class DailyRecordSummaryResponseDtoSummariesInnerLatest {
  /// Returns a new [DailyRecordSummaryResponseDtoSummariesInnerLatest] instance.
  DailyRecordSummaryResponseDtoSummariesInnerLatest({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: DailyRecordSummaryResponseDtoSummariesInnerLatestKindEnum
        .unknownDefaultOpenApi,
  )
  final DailyRecordSummaryResponseDtoSummariesInnerLatestKindEnum kind;
  ...
  bool operator ==(Object other) =>
      ...
      other is DailyRecordSummaryResponseDtoSummariesInnerLatest &&
          other.id == id &&
          other.kind == kind &&
  ...
  factory DailyRecordSummaryResponseDtoSummariesInnerLatest.fromJson(
    Map<String, dynamic> json,
  ) => _$DailyRecordSummaryResponseDtoSummariesInnerLatestFromJson(json);

  Map<String, dynamic> toJson() =>
      _$DailyRecordSummaryResponseDtoSummariesInnerLatestToJson(this);
...
enum DailyRecordSummaryResponseDtoSummariesInnerLatestKindEnum {
  @JsonValue(r'water')
  water(r'water'),
  @JsonValue(r'meal')
  meal(r'meal'),
  ...
  const DailyRecordSummaryResponseDtoSummariesInnerLatestKindEnum(this.value);
