...
part 'user_settings_response_dto_assistant_context.g.dart';
...
class UserSettingsResponseDtoAssistantContext {
  /// Returns a new [UserSettingsResponseDtoAssistantContext] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is UserSettingsResponseDtoAssistantContext &&
  ...
  factory UserSettingsResponseDtoAssistantContext.fromJson(
    Map<String, dynamic> json,
  ) => _$UserSettingsResponseDtoAssistantContextFromJson(json);

  Map<String, dynamic> toJson() =>
      _$UserSettingsResponseDtoAssistantContextToJson(this);
