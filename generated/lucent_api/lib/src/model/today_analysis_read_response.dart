...
part 'today_analysis_read_response.g.dart';
...
class TodayAnalysisReadResponse {
  /// Returns a new [TodayAnalysisReadResponse] instance.
  ...
  final TodayAnalysisReadResponseAnalysis? analysis;

  @JsonKey(
    name: r'status',
    required: true,
    includeIfNull: false,
    unknownEnumValue: TodayAnalysisReadResponseStatusEnum.unknownDefaultOpenApi,
  )
  final TodayAnalysisReadResponseStatusEnum status;
  ...
  bool operator ==(Object other) =>
      ...
      other is TodayAnalysisReadResponse &&
  ...
  factory TodayAnalysisReadResponse.fromJson(Map<String, dynamic> json) =>
      _$TodayAnalysisReadResponseFromJson(json);

  Map<String, dynamic> toJson() => _$TodayAnalysisReadResponseToJson(this);
...
enum TodayAnalysisReadResponseStatusEnum {
  @JsonValue(r'empty')
  empty(r'empty'),
  @JsonValue(r'pending')
  pending(r'pending'),
  ...
  const TodayAnalysisReadResponseStatusEnum(this.value);
