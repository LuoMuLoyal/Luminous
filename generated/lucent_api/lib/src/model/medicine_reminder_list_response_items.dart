...
part 'medicine_reminder_list_response_items.g.dart';
...
class MedicineReminderListResponseItems {
  /// Returns a new [MedicineReminderListResponseItems] instance.
  MedicineReminderListResponseItems({
    required this.id,
  ...
  bool operator ==(Object other) =>
      ...
      other is MedicineReminderListResponseItems &&
          other.id == id &&
  ...
  factory MedicineReminderListResponseItems.fromJson(
    Map<String, dynamic> json,
  ) => _$MedicineReminderListResponseItemsFromJson(json);

  Map<String, dynamic> toJson() =>
      _$MedicineReminderListResponseItemsToJson(this);
