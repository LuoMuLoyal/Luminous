...
part 'event_review_data_coverage_check_ins.g.dart';
...
class EventReviewDataCoverageCheckIns {
  /// Returns a new [EventReviewDataCoverageCheckIns] instance.
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        EventReviewDataCoverageCheckInsStateEnum.unknownDefaultOpenApi,
  )
  final EventReviewDataCoverageCheckInsStateEnum state;
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        EventReviewDataCoverageCheckInsCoverageEnum.unknownDefaultOpenApi,
  )
  final EventReviewDataCoverageCheckInsCoverageEnum coverage;

  @JsonKey(name: r'sources', required: true, includeIfNull: false)
  final List<EventReviewDataCoverageCheckInsSourcesEnum> sources;
  ...
  final EventReviewDataCoverageCheckInsTodayCheckIn? todayCheckIn;
  ...
  bool operator ==(Object other) =>
      ...
      other is EventReviewDataCoverageCheckIns &&
          other.state == state &&
  ...
  factory EventReviewDataCoverageCheckIns.fromJson(Map<String, dynamic> json) =>
      _$EventReviewDataCoverageCheckInsFromJson(json);

  Map<String, dynamic> toJson() =>
      _$EventReviewDataCoverageCheckInsToJson(this);
...
enum EventReviewDataCoverageCheckInsStateEnum {
  ...
  const EventReviewDataCoverageCheckInsStateEnum(this.value);
...
/// 'none' when no check-ins exist; 'partial' when check-ins exist but sufficiency is not yet assessed by the section services.
enum EventReviewDataCoverageCheckInsCoverageEnum {
  ...
  const EventReviewDataCoverageCheckInsCoverageEnum(this.value);
...
enum EventReviewDataCoverageCheckInsSourcesEnum {
  @JsonValue(r'manual')
  manual(r'manual'),
  ...
  const EventReviewDataCoverageCheckInsSourcesEnum(this.value);
