...
part 'login_response_dto_user.g.dart';
...
class LoginResponseDtoUser {
  /// Returns a new [LoginResponseDtoUser] instance.
  ...
  factory LoginResponseDtoUser.fromJson(Map<String, dynamic> json) =>
      _$LoginResponseDtoUserFromJson(json);

  Map<String, dynamic> toJson() => _$LoginResponseDtoUserToJson(this);
