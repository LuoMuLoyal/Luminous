...
part 'suggestion_explanation_async_response_dto_result.g.dart';
...
class SuggestionExplanationAsyncResponseDtoResult {
  /// Returns a new [SuggestionExplanationAsyncResponseDtoResult] instance.
  SuggestionExplanationAsyncResponseDtoResult({
  ...
  bool operator ==(Object other) =>
      ...
      other is SuggestionExplanationAsyncResponseDtoResult &&
  ...
  factory SuggestionExplanationAsyncResponseDtoResult.fromJson(
    Map<String, dynamic> json,
  ) => _$SuggestionExplanationAsyncResponseDtoResultFromJson(json);

  Map<String, dynamic> toJson() =>
      _$SuggestionExplanationAsyncResponseDtoResultToJson(this);
