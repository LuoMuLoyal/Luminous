...
part 'reminder_delivery_receipt_response_dto_item.g.dart';
...
class ReminderDeliveryReceiptResponseDtoItem {
  /// Returns a new [ReminderDeliveryReceiptResponseDtoItem] instance.
  ReminderDeliveryReceiptResponseDtoItem({
    required this.id,
  ...
  bool operator ==(Object other) =>
      ...
      other is ReminderDeliveryReceiptResponseDtoItem &&
          other.id == id &&
  ...
  factory ReminderDeliveryReceiptResponseDtoItem.fromJson(
    Map<String, dynamic> json,
  ) => _$ReminderDeliveryReceiptResponseDtoItemFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ReminderDeliveryReceiptResponseDtoItemToJson(this);
