...
part 'report_summary_async_response_dto_result.g.dart';
...
class ReportSummaryAsyncResponseDtoResult {
  /// Returns a new [ReportSummaryAsyncResponseDtoResult] instance.
  ReportSummaryAsyncResponseDtoResult({
    required this.range,
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        ReportSummaryAsyncResponseDtoResultRangeEnum.unknownDefaultOpenApi,
  )
  final ReportSummaryAsyncResponseDtoResultRangeEnum range;
  ...
  bool operator ==(Object other) =>
      ...
      other is ReportSummaryAsyncResponseDtoResult &&
          other.range == range &&
  ...
  factory ReportSummaryAsyncResponseDtoResult.fromJson(
    Map<String, dynamic> json,
  ) => _$ReportSummaryAsyncResponseDtoResultFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ReportSummaryAsyncResponseDtoResultToJson(this);
...
enum ReportSummaryAsyncResponseDtoResultRangeEnum {
  ...
  const ReportSummaryAsyncResponseDtoResultRangeEnum(this.value);
