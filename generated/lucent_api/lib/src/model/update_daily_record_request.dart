...
part 'update_daily_record_request.g.dart';
...
class UpdateDailyRecordRequest {
  /// Returns a new [UpdateDailyRecordRequest] instance.
  ...
  @JsonKey(
    ...
    required: false,
    includeIfNull: false,
    unknownEnumValue: UpdateDailyRecordRequestKindEnum.unknownDefaultOpenApi,
  )
  final UpdateDailyRecordRequestKindEnum? kind;
  ...
  final List<UpdateDailyRecordRequestAttachments>? attachments;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is UpdateDailyRecordRequest &&
          other.kind == kind &&
  ...
  factory UpdateDailyRecordRequest.fromJson(Map<String, dynamic> json) =>
      _$UpdateDailyRecordRequestFromJson(json);

  Map<String, dynamic> toJson() => _$UpdateDailyRecordRequestToJson(this);
...
enum UpdateDailyRecordRequestKindEnum {
  @JsonValue(r'water')
  water(r'water'),
  @JsonValue(r'meal')
  meal(r'meal'),
  ...
  const UpdateDailyRecordRequestKindEnum(this.value);
