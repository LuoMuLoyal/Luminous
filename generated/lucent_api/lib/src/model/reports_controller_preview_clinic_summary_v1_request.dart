...
part 'reports_controller_preview_clinic_summary_v1_request.g.dart';
...
class ReportsControllerPreviewClinicSummaryV1Request {
  /// Returns a new [ReportsControllerPreviewClinicSummaryV1Request] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is ReportsControllerPreviewClinicSummaryV1Request &&
  ...
  factory ReportsControllerPreviewClinicSummaryV1Request.fromJson(
    Map<String, dynamic> json,
  ) => _$ReportsControllerPreviewClinicSummaryV1RequestFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ReportsControllerPreviewClinicSummaryV1RequestToJson(this);
...
enum ReportsControllerPreviewClinicSummaryV1RequestSelectedFieldsEnum {
  ...
  const ReportsControllerPreviewClinicSummaryV1RequestSelectedFieldsEnum(
    this.value,
  );
