...
part 'daily_records_controller_create_v1_request_attachments_inner.g.dart';
...
class DailyRecordsControllerCreateV1RequestAttachmentsInner {
  /// Returns a new [DailyRecordsControllerCreateV1RequestAttachmentsInner] instance.
  DailyRecordsControllerCreateV1RequestAttachmentsInner({
    this.kind,
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        DailyRecordsControllerCreateV1RequestAttachmentsInnerKindEnum
            .unknownDefaultOpenApi,
  )
  final DailyRecordsControllerCreateV1RequestAttachmentsInnerKindEnum? kind;
  ...
  bool operator ==(Object other) =>
      ...
      other is DailyRecordsControllerCreateV1RequestAttachmentsInner &&
          other.kind == kind &&
  ...
  factory DailyRecordsControllerCreateV1RequestAttachmentsInner.fromJson(
    Map<String, dynamic> json,
  ) => _$DailyRecordsControllerCreateV1RequestAttachmentsInnerFromJson(json);

  Map<String, dynamic> toJson() =>
      _$DailyRecordsControllerCreateV1RequestAttachmentsInnerToJson(this);
...
/// Attachment kind. Defaults to \"image\".
enum DailyRecordsControllerCreateV1RequestAttachmentsInnerKindEnum {
  @JsonValue(r'image')
  image(r'image'),
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi(r'unknown_default_open_api');

  const DailyRecordsControllerCreateV1RequestAttachmentsInnerKindEnum(
    this.value,
  );
