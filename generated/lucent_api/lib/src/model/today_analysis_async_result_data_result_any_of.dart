...
part 'today_analysis_async_result_data_result_any_of.g.dart';
...
class TodayAnalysisAsyncResultDataResultAnyOf {
  /// Returns a new [TodayAnalysisAsyncResultDataResultAnyOf] instance.
  TodayAnalysisAsyncResultDataResultAnyOf({
    required this.date,
  ...
  bool operator ==(Object other) =>
      ...
      other is TodayAnalysisAsyncResultDataResultAnyOf &&
          other.date == date &&
  ...
  factory TodayAnalysisAsyncResultDataResultAnyOf.fromJson(
    Map<String, dynamic> json,
  ) => _$TodayAnalysisAsyncResultDataResultAnyOfFromJson(json);

  Map<String, dynamic> toJson() =>
      _$TodayAnalysisAsyncResultDataResultAnyOfToJson(this);
