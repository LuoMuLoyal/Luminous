...
part 'daily_records_controller_update_v1_request.g.dart';
...
class DailyRecordsControllerUpdateV1Request {
  /// Returns a new [DailyRecordsControllerUpdateV1Request] instance.
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        DailyRecordsControllerUpdateV1RequestKindEnum.unknownDefaultOpenApi,
  )
  final DailyRecordsControllerUpdateV1RequestKindEnum? kind;
  ...
  bool operator ==(Object other) =>
      ...
      other is DailyRecordsControllerUpdateV1Request &&
          other.kind == kind &&
  ...
  factory DailyRecordsControllerUpdateV1Request.fromJson(
    Map<String, dynamic> json,
  ) => _$DailyRecordsControllerUpdateV1RequestFromJson(json);

  Map<String, dynamic> toJson() =>
      _$DailyRecordsControllerUpdateV1RequestToJson(this);
...
enum DailyRecordsControllerUpdateV1RequestKindEnum {
  @JsonValue(r'water')
  water(r'water'),
  @JsonValue(r'meal')
  meal(r'meal'),
  ...
  const DailyRecordsControllerUpdateV1RequestKindEnum(this.value);
