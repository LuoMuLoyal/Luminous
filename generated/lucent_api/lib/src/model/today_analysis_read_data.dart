...
part 'today_analysis_read_data.g.dart';
...
class TodayAnalysisReadData {
  /// Returns a new [TodayAnalysisReadData] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: TodayAnalysisReadDataStatusEnum.unknownDefaultOpenApi,
  )
  final TodayAnalysisReadDataStatusEnum status;
  ...
  bool operator ==(Object other) =>
      ...
      other is TodayAnalysisReadData &&
  ...
  factory TodayAnalysisReadData.fromJson(Map<String, dynamic> json) =>
      _$TodayAnalysisReadDataFromJson(json);

  Map<String, dynamic> toJson() => _$TodayAnalysisReadDataToJson(this);
...
enum TodayAnalysisReadDataStatusEnum {
  @JsonValue(r'empty')
  empty(r'empty'),
  @JsonValue(r'pending')
  pending(r'pending'),
  ...
  const TodayAnalysisReadDataStatusEnum(this.value);
