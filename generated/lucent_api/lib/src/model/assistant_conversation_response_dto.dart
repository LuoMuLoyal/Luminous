...
class AssistantConversationResponseDto {
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        AssistantConversationResponseDtoStatusEnum.unknownDefaultOpenApi,
  )
  final AssistantConversationResponseDtoStatusEnum status;
...
/// Current conversation status.
enum AssistantConversationResponseDtoStatusEnum {
  /// Current conversation status.
  @JsonValue(r'active')
  active(r'active'),
  ...
  const AssistantConversationResponseDtoStatusEnum(this.value);
