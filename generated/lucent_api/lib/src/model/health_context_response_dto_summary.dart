...
part 'health_context_response_dto_summary.g.dart';
...
class HealthContextResponseDtoSummary {
  /// Returns a new [HealthContextResponseDtoSummary] instance.
  HealthContextResponseDtoSummary({
    required this.age,
  ...
  bool operator ==(Object other) =>
      ...
      other is HealthContextResponseDtoSummary &&
          other.age == age &&
  ...
  factory HealthContextResponseDtoSummary.fromJson(Map<String, dynamic> json) =>
      _$HealthContextResponseDtoSummaryFromJson(json);

  Map<String, dynamic> toJson() =>
      _$HealthContextResponseDtoSummaryToJson(this);
