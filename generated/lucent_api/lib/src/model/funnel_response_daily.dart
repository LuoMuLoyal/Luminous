...
part 'funnel_response_daily.g.dart';
...
class FunnelResponseDaily {
  /// Returns a new [FunnelResponseDaily] instance.
  FunnelResponseDaily({
    required this.date,
  ...
  factory FunnelResponseDaily.fromJson(Map<String, dynamic> json) =>
      _$FunnelResponseDailyFromJson(json);

  Map<String, dynamic> toJson() => _$FunnelResponseDailyToJson(this);
