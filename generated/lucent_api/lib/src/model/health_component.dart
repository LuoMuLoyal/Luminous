...
import 'package:lucent_api/src/model/health_component_status.dart';
...
class HealthComponent {
  /// Returns a new [HealthComponent] instance.
  HealthComponent({
    required this.name,
  ...
  Map<String, dynamic> toJson() => _$HealthComponentToJson(this);
