...
part 'notification_list_response_items.g.dart';
...
class NotificationListResponseItems {
  /// Returns a new [NotificationListResponseItems] instance.
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        NotificationListResponseItemsTypeEnum.unknownDefaultOpenApi,
  )
  final NotificationListResponseItemsTypeEnum type;
  ...
  bool operator ==(Object other) =>
      ...
      other is NotificationListResponseItems &&
          other.id == id &&
          other.type == type &&
          other.title == title &&
  ...
  factory NotificationListResponseItems.fromJson(Map<String, dynamic> json) =>
      _$NotificationListResponseItemsFromJson(json);

  Map<String, dynamic> toJson() => _$NotificationListResponseItemsToJson(this);
...
enum NotificationListResponseItemsTypeEnum {
  ...
  const NotificationListResponseItemsTypeEnum(this.value);
