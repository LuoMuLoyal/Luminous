...
part 'today_analysis_async_result_data_result_any_of1.g.dart';
...
class TodayAnalysisAsyncResultDataResultAnyOf1 {
  /// Returns a new [TodayAnalysisAsyncResultDataResultAnyOf1] instance.
  TodayAnalysisAsyncResultDataResultAnyOf1({
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: TodayAnalysisAsyncResultDataResultAnyOf1StatusEnum
        .unknownDefaultOpenApi,
  )
  final TodayAnalysisAsyncResultDataResultAnyOf1StatusEnum status;
  ...
  bool operator ==(Object other) =>
      ...
      other is TodayAnalysisAsyncResultDataResultAnyOf1 &&
  ...
  factory TodayAnalysisAsyncResultDataResultAnyOf1.fromJson(
    Map<String, dynamic> json,
  ) => _$TodayAnalysisAsyncResultDataResultAnyOf1FromJson(json);

  Map<String, dynamic> toJson() =>
      _$TodayAnalysisAsyncResultDataResultAnyOf1ToJson(this);
...
enum TodayAnalysisAsyncResultDataResultAnyOf1StatusEnum {
  @JsonValue(r'empty')
  empty(r'empty'),
  @JsonValue(r'pending')
  pending(r'pending'),
  ...
  const TodayAnalysisAsyncResultDataResultAnyOf1StatusEnum(this.value);
