...
class HealthEventNullableResponseDto {
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        HealthEventNullableResponseDtoKindEnum.unknownDefaultOpenApi,
  )
  final HealthEventNullableResponseDtoKindEnum kind;
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        HealthEventNullableResponseDtoStatusEnum.unknownDefaultOpenApi,
  )
  final HealthEventNullableResponseDtoStatusEnum status;
  ...
  @JsonKey(
    ...
    includeIfNull: true,
    unknownEnumValue:
        HealthEventNullableResponseDtoOutcomeEnum.unknownDefaultOpenApi,
  )
  final HealthEventNullableResponseDtoOutcomeEnum? outcome;
...
enum HealthEventNullableResponseDtoKindEnum {
  @JsonValue(r'symptom')
  symptom(r'symptom'),
  @JsonValue(r'other')
  other(r'other'),
  ...
  const HealthEventNullableResponseDtoKindEnum(this.value);
...
enum HealthEventNullableResponseDtoStatusEnum {
  @JsonValue(r'active')
  active(r'active'),
  @JsonValue(r'ended')
  ended(r'ended'),
  ...
  const HealthEventNullableResponseDtoStatusEnum(this.value);
...
enum HealthEventNullableResponseDtoOutcomeEnum {
  ...
  const HealthEventNullableResponseDtoOutcomeEnum(this.value);
