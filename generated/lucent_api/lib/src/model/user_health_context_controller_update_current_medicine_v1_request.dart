...
part 'user_health_context_controller_update_current_medicine_v1_request.g.dart';
...
class UserHealthContextControllerUpdateCurrentMedicineV1Request {
  /// Returns a new [UserHealthContextControllerUpdateCurrentMedicineV1Request] instance.
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        UserHealthContextControllerUpdateCurrentMedicineV1RequestSource_Enum
            .unknownDefaultOpenApi,
  )
  final UserHealthContextControllerUpdateCurrentMedicineV1RequestSource_Enum?
  source_;
  ...
  bool operator ==(Object other) =>
      ...
      other is UserHealthContextControllerUpdateCurrentMedicineV1Request &&
  ...
  factory UserHealthContextControllerUpdateCurrentMedicineV1Request.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$UserHealthContextControllerUpdateCurrentMedicineV1RequestFromJson(json);

  Map<String, dynamic> toJson() =>
      _$UserHealthContextControllerUpdateCurrentMedicineV1RequestToJson(this);
...
/// Upstream source.
enum UserHealthContextControllerUpdateCurrentMedicineV1RequestSource_Enum {
  ...
  const UserHealthContextControllerUpdateCurrentMedicineV1RequestSource_Enum(
    this.value,
  );
