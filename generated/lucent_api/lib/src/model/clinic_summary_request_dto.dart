...
part 'clinic_summary_request_dto.g.dart';
...
class ClinicSummaryRequestDto {
  /// Returns a new [ClinicSummaryRequestDto] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is ClinicSummaryRequestDto &&
  ...
  factory ClinicSummaryRequestDto.fromJson(Map<String, dynamic> json) =>
      _$ClinicSummaryRequestDtoFromJson(json);

  Map<String, dynamic> toJson() => _$ClinicSummaryRequestDtoToJson(this);
...
enum ClinicSummaryRequestDtoSelectedFieldsEnum {
  ...
  const ClinicSummaryRequestDtoSelectedFieldsEnum(this.value);
