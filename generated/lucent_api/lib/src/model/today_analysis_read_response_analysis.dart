...
part 'today_analysis_read_response_analysis.g.dart';
...
class TodayAnalysisReadResponseAnalysis {
  /// Returns a new [TodayAnalysisReadResponseAnalysis] instance.
  ...
  final List<TodayAnalysisReadResponseAnalysisBullets> bullets;
  ...
  final List<TodayAnalysisReadResponseAnalysisMetrics>? metrics;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is TodayAnalysisReadResponseAnalysis &&
          other.date == date &&
  ...
  factory TodayAnalysisReadResponseAnalysis.fromJson(
    Map<String, dynamic> json,
  ) => _$TodayAnalysisReadResponseAnalysisFromJson(json);

  Map<String, dynamic> toJson() =>
      _$TodayAnalysisReadResponseAnalysisToJson(this);
