...
part 'health_event_response_dto_coverage.g.dart';
...
class HealthEventResponseDtoCoverage {
  /// Returns a new [HealthEventResponseDtoCoverage] instance.
  HealthEventResponseDtoCoverage({
  ...
  bool operator ==(Object other) =>
      ...
      other is HealthEventResponseDtoCoverage &&
  ...
  factory HealthEventResponseDtoCoverage.fromJson(Map<String, dynamic> json) =>
      _$HealthEventResponseDtoCoverageFromJson(json);

  Map<String, dynamic> toJson() => _$HealthEventResponseDtoCoverageToJson(this);
