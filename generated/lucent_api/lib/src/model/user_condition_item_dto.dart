...
import 'package:lucent_api/src/model/user_condition_status.dart';
...
class UserConditionItemDto {
  ...
  factory UserConditionItemDto.fromJson(Map<String, dynamic> json) =>
