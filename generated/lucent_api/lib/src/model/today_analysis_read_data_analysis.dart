...
part 'today_analysis_read_data_analysis.g.dart';
...
class TodayAnalysisReadDataAnalysis {
  /// Returns a new [TodayAnalysisReadDataAnalysis] instance.
  ...
  final List<TodayAnalysisReadDataAnalysisBullets> bullets;
  ...
  final List<TodayAnalysisReadDataAnalysisMetrics>? metrics;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is TodayAnalysisReadDataAnalysis &&
          other.date == date &&
  ...
  factory TodayAnalysisReadDataAnalysis.fromJson(Map<String, dynamic> json) =>
      _$TodayAnalysisReadDataAnalysisFromJson(json);

  Map<String, dynamic> toJson() => _$TodayAnalysisReadDataAnalysisToJson(this);
