...
part 'today_analysis_read_response_dto_analysis.g.dart';
...
class TodayAnalysisReadResponseDtoAnalysis {
  /// Returns a new [TodayAnalysisReadResponseDtoAnalysis] instance.
  TodayAnalysisReadResponseDtoAnalysis({
    required this.date,
  ...
  bool operator ==(Object other) =>
      ...
      other is TodayAnalysisReadResponseDtoAnalysis &&
          other.date == date &&
  ...
  factory TodayAnalysisReadResponseDtoAnalysis.fromJson(
    Map<String, dynamic> json,
  ) => _$TodayAnalysisReadResponseDtoAnalysisFromJson(json);

  Map<String, dynamic> toJson() =>
      _$TodayAnalysisReadResponseDtoAnalysisToJson(this);
