...
part 'today_analysis_refresh_ready_data_analysis.g.dart';
...
class TodayAnalysisRefreshReadyDataAnalysis {
  /// Returns a new [TodayAnalysisRefreshReadyDataAnalysis] instance.
  ...
  final List<TodayAnalysisRefreshReadyDataAnalysisBullets> bullets;
  ...
  final List<TodayAnalysisRefreshReadyDataAnalysisMetrics>? metrics;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is TodayAnalysisRefreshReadyDataAnalysis &&
          other.date == date &&
  ...
  factory TodayAnalysisRefreshReadyDataAnalysis.fromJson(
    Map<String, dynamic> json,
  ) => _$TodayAnalysisRefreshReadyDataAnalysisFromJson(json);

  Map<String, dynamic> toJson() =>
      _$TodayAnalysisRefreshReadyDataAnalysisToJson(this);
