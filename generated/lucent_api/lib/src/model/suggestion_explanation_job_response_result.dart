...
part 'suggestion_explanation_job_response_result.g.dart';
...
class SuggestionExplanationJobResponseResult {
  /// Returns a new [SuggestionExplanationJobResponseResult] instance.
  SuggestionExplanationJobResponseResult({
  ...
  bool operator ==(Object other) =>
      ...
      other is SuggestionExplanationJobResponseResult &&
  ...
  factory SuggestionExplanationJobResponseResult.fromJson(
    Map<String, dynamic> json,
  ) => _$SuggestionExplanationJobResponseResultFromJson(json);

  Map<String, dynamic> toJson() =>
      _$SuggestionExplanationJobResponseResultToJson(this);
