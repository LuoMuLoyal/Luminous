...
part 'daily_record_response_attachments.g.dart';
...
class DailyRecordResponseAttachments {
  /// Returns a new [DailyRecordResponseAttachments] instance.
  DailyRecordResponseAttachments({
    required this.id,
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        DailyRecordResponseAttachmentsKindEnum.unknownDefaultOpenApi,
  )
  final DailyRecordResponseAttachmentsKindEnum kind;
  ...
  bool operator ==(Object other) =>
      ...
      other is DailyRecordResponseAttachments &&
          other.id == id &&
          other.kind == kind &&
  ...
  factory DailyRecordResponseAttachments.fromJson(Map<String, dynamic> json) =>
      _$DailyRecordResponseAttachmentsFromJson(json);

  Map<String, dynamic> toJson() => _$DailyRecordResponseAttachmentsToJson(this);
...
enum DailyRecordResponseAttachmentsKindEnum {
  @JsonValue(r'image')
  image(r'image'),
  @JsonValue(r'unknown_default_open_api')
  unknownDefaultOpenApi(r'unknown_default_open_api');

  const DailyRecordResponseAttachmentsKindEnum(this.value);
