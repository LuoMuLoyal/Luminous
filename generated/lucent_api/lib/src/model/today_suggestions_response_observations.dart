...
part 'today_suggestions_response_observations.g.dart';
...
class TodaySuggestionsResponseObservations {
  /// Returns a new [TodaySuggestionsResponseObservations] instance.
  TodaySuggestionsResponseObservations({
    required this.id,
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        TodaySuggestionsResponseObservationsTypeEnum.unknownDefaultOpenApi,
  )
  final TodaySuggestionsResponseObservationsTypeEnum type;
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        TodaySuggestionsResponseObservationsCardToneEnum.unknownDefaultOpenApi,
  )
  final TodaySuggestionsResponseObservationsCardToneEnum cardTone;
  ...
  final List<TodaySuggestionsResponseObservationsEvidence> evidence;
  ...
  final TodaySuggestionsResponseObservationsPrimaryAction primaryAction;

  /// Secondary actions
  @JsonKey(name: r'secondaryActions', required: false, includeIfNull: false)
  final List<TodaySuggestionsResponseObservationsSecondaryActions>?
  secondaryActions;
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: TodaySuggestionsResponseObservationsConfidenceEnum
        .unknownDefaultOpenApi,
  )
  final TodaySuggestionsResponseObservationsConfidenceEnum confidence;
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: TodaySuggestionsResponseObservationsTriggerTypeEnum
        .unknownDefaultOpenApi,
  )
  final TodaySuggestionsResponseObservationsTriggerTypeEnum triggerType;
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: TodaySuggestionsResponseObservationsLifecycleStateEnum
        .unknownDefaultOpenApi,
  )
  final TodaySuggestionsResponseObservationsLifecycleStateEnum lifecycleState;
  ...
  final List<TodaySuggestionsResponseObservationsFeedbackOptionsEnum>?
  feedbackOptions;
  ...
  final TodaySuggestionsResponseObservationsObservedMetric? observedMetric;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is TodaySuggestionsResponseObservations &&
          other.id == id &&
          other.type == type &&
  ...
  factory TodaySuggestionsResponseObservations.fromJson(
    Map<String, dynamic> json,
  ) => _$TodaySuggestionsResponseObservationsFromJson(json);

  Map<String, dynamic> toJson() =>
      _$TodaySuggestionsResponseObservationsToJson(this);
...
/// Suggestion type
enum TodaySuggestionsResponseObservationsTypeEnum {
  ...
  const TodaySuggestionsResponseObservationsTypeEnum(this.value);
...
/// Visual tone hint
enum TodaySuggestionsResponseObservationsCardToneEnum {
  @JsonValue(r'urgent')
  urgent(r'urgent'),
  @JsonValue(r'warning')
  warning(r'warning'),
  ...
  const TodaySuggestionsResponseObservationsCardToneEnum(this.value);
...
/// Confidence level
enum TodaySuggestionsResponseObservationsConfidenceEnum {
  @JsonValue(r'high')
  high(r'high'),
  @JsonValue(r'medium')
  medium(r'medium'),
  ...
  const TodaySuggestionsResponseObservationsConfidenceEnum(this.value);
...
/// Trigger type
enum TodaySuggestionsResponseObservationsTriggerTypeEnum {
  @JsonValue(r'event')
  event(r'event'),
  @JsonValue(r'timer')
  timer(r'timer'),
  ...
  const TodaySuggestionsResponseObservationsTriggerTypeEnum(this.value);
...
/// Lifecycle state
enum TodaySuggestionsResponseObservationsLifecycleStateEnum {
  ...
  const TodaySuggestionsResponseObservationsLifecycleStateEnum(this.value);
...
enum TodaySuggestionsResponseObservationsFeedbackOptionsEnum {
  ...
  const TodaySuggestionsResponseObservationsFeedbackOptionsEnum(this.value);
