...
part 'share_clinic_summary_request.g.dart';
...
class ShareClinicSummaryRequest {
  /// Returns a new [ShareClinicSummaryRequest] instance.
  ...
  final List<ShareClinicSummaryRequestSelectedFieldsEnum>? selectedFields;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ShareClinicSummaryRequest &&
  ...
  factory ShareClinicSummaryRequest.fromJson(Map<String, dynamic> json) =>
      _$ShareClinicSummaryRequestFromJson(json);

  Map<String, dynamic> toJson() => _$ShareClinicSummaryRequestToJson(this);
...
enum ShareClinicSummaryRequestSelectedFieldsEnum {
  ...
  const ShareClinicSummaryRequestSelectedFieldsEnum(this.value);
