...
part 'download_clinic_summary_pdf_request.g.dart';
...
class DownloadClinicSummaryPdfRequest {
  /// Returns a new [DownloadClinicSummaryPdfRequest] instance.
  ...
  final List<DownloadClinicSummaryPdfRequestSelectedFieldsEnum>? selectedFields;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is DownloadClinicSummaryPdfRequest &&
  ...
  factory DownloadClinicSummaryPdfRequest.fromJson(Map<String, dynamic> json) =>
      _$DownloadClinicSummaryPdfRequestFromJson(json);

  Map<String, dynamic> toJson() =>
      _$DownloadClinicSummaryPdfRequestToJson(this);
...
enum DownloadClinicSummaryPdfRequestSelectedFieldsEnum {
  ...
  const DownloadClinicSummaryPdfRequestSelectedFieldsEnum(this.value);
