...
part 'today_suggestions_response_secondary.g.dart';
...
class TodaySuggestionsResponseSecondary {
  /// Returns a new [TodaySuggestionsResponseSecondary] instance.
  TodaySuggestionsResponseSecondary({
    required this.id,
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        TodaySuggestionsResponseSecondaryTypeEnum.unknownDefaultOpenApi,
  )
  final TodaySuggestionsResponseSecondaryTypeEnum type;
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        TodaySuggestionsResponseSecondaryCardToneEnum.unknownDefaultOpenApi,
  )
  final TodaySuggestionsResponseSecondaryCardToneEnum cardTone;
  ...
  final List<TodaySuggestionsResponseSecondaryEvidence> evidence;
  ...
  final TodaySuggestionsResponseSecondaryPrimaryAction primaryAction;

  /// Secondary actions
  @JsonKey(name: r'secondaryActions', required: false, includeIfNull: false)
  final List<TodaySuggestionsResponseSecondarySecondaryActions>?
  secondaryActions;
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        TodaySuggestionsResponseSecondaryConfidenceEnum.unknownDefaultOpenApi,
  )
  final TodaySuggestionsResponseSecondaryConfidenceEnum confidence;
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        TodaySuggestionsResponseSecondaryTriggerTypeEnum.unknownDefaultOpenApi,
  )
  final TodaySuggestionsResponseSecondaryTriggerTypeEnum triggerType;
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: TodaySuggestionsResponseSecondaryLifecycleStateEnum
        .unknownDefaultOpenApi,
  )
  final TodaySuggestionsResponseSecondaryLifecycleStateEnum lifecycleState;
  ...
  final List<TodaySuggestionsResponseSecondaryFeedbackOptionsEnum>?
  feedbackOptions;
  ...
  final TodaySuggestionsResponseSecondaryObservedMetric? observedMetric;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is TodaySuggestionsResponseSecondary &&
          other.id == id &&
          other.type == type &&
  ...
  factory TodaySuggestionsResponseSecondary.fromJson(
    Map<String, dynamic> json,
  ) => _$TodaySuggestionsResponseSecondaryFromJson(json);

  Map<String, dynamic> toJson() =>
      _$TodaySuggestionsResponseSecondaryToJson(this);
...
/// Suggestion type
enum TodaySuggestionsResponseSecondaryTypeEnum {
  ...
  const TodaySuggestionsResponseSecondaryTypeEnum(this.value);
...
/// Visual tone hint
enum TodaySuggestionsResponseSecondaryCardToneEnum {
  @JsonValue(r'urgent')
  urgent(r'urgent'),
  @JsonValue(r'warning')
  warning(r'warning'),
  ...
  const TodaySuggestionsResponseSecondaryCardToneEnum(this.value);
...
/// Confidence level
enum TodaySuggestionsResponseSecondaryConfidenceEnum {
  @JsonValue(r'high')
  high(r'high'),
  @JsonValue(r'medium')
  medium(r'medium'),
  ...
  const TodaySuggestionsResponseSecondaryConfidenceEnum(this.value);
...
/// Trigger type
enum TodaySuggestionsResponseSecondaryTriggerTypeEnum {
  @JsonValue(r'event')
  event(r'event'),
  @JsonValue(r'timer')
  timer(r'timer'),
  ...
  const TodaySuggestionsResponseSecondaryTriggerTypeEnum(this.value);
...
/// Lifecycle state
enum TodaySuggestionsResponseSecondaryLifecycleStateEnum {
  ...
  const TodaySuggestionsResponseSecondaryLifecycleStateEnum(this.value);
...
enum TodaySuggestionsResponseSecondaryFeedbackOptionsEnum {
  ...
  const TodaySuggestionsResponseSecondaryFeedbackOptionsEnum(this.value);
