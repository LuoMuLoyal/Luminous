...
part 'event_review_data_dto_coverage_check_ins.g.dart';
...
class EventReviewDataDtoCoverageCheckIns {
  /// Returns a new [EventReviewDataDtoCoverageCheckIns] instance.
  EventReviewDataDtoCoverageCheckIns({
    required this.state,
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        EventReviewDataDtoCoverageCheckInsStateEnum.unknownDefaultOpenApi,
  )
  final EventReviewDataDtoCoverageCheckInsStateEnum state;
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        EventReviewDataDtoCoverageCheckInsCoverageEnum.unknownDefaultOpenApi,
  )
  final EventReviewDataDtoCoverageCheckInsCoverageEnum coverage;

  @JsonKey(name: r'sources', required: true, includeIfNull: false)
  final List<EventReviewDataDtoCoverageCheckInsSourcesEnum> sources;
  ...
  final EventReviewDataDtoCoverageCheckInsTodayCheckIn? todayCheckIn;
  ...
  bool operator ==(Object other) =>
      ...
      other is EventReviewDataDtoCoverageCheckIns &&
          other.state == state &&
  ...
  factory EventReviewDataDtoCoverageCheckIns.fromJson(
    Map<String, dynamic> json,
  ) => _$EventReviewDataDtoCoverageCheckInsFromJson(json);

  Map<String, dynamic> toJson() =>
      _$EventReviewDataDtoCoverageCheckInsToJson(this);
...
enum EventReviewDataDtoCoverageCheckInsStateEnum {
  ...
  const EventReviewDataDtoCoverageCheckInsStateEnum(this.value);
...
/// 'none' when no check-ins exist; 'partial' when check-ins exist but sufficiency is not yet assessed by the section services.
enum EventReviewDataDtoCoverageCheckInsCoverageEnum {
  ...
  const EventReviewDataDtoCoverageCheckInsCoverageEnum(this.value);
...
enum EventReviewDataDtoCoverageCheckInsSourcesEnum {
  @JsonValue(r'manual')
  manual(r'manual'),
  ...
  const EventReviewDataDtoCoverageCheckInsSourcesEnum(this.value);
