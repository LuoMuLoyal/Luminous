...
part 'health_event_list_response_items_coverage.g.dart';
...
class HealthEventListResponseItemsCoverage {
  /// Returns a new [HealthEventListResponseItemsCoverage] instance.
  HealthEventListResponseItemsCoverage({
  ...
  bool operator ==(Object other) =>
      ...
      other is HealthEventListResponseItemsCoverage &&
  ...
  factory HealthEventListResponseItemsCoverage.fromJson(
    Map<String, dynamic> json,
  ) => _$HealthEventListResponseItemsCoverageFromJson(json);

  Map<String, dynamic> toJson() =>
      _$HealthEventListResponseItemsCoverageToJson(this);
