...
part 'user_health_context_controller_update_user_health_context_profile_v1_request.g.dart';
...
class UserHealthContextControllerUpdateUserHealthContextProfileV1Request {
  /// Returns a new [UserHealthContextControllerUpdateUserHealthContextProfileV1Request] instance.
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        UserHealthContextControllerUpdateUserHealthContextProfileV1RequestUnitSystemEnum
            .unknownDefaultOpenApi,
  )
  final UserHealthContextControllerUpdateUserHealthContextProfileV1RequestUnitSystemEnum?
  unitSystem;
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        UserHealthContextControllerUpdateUserHealthContextProfileV1RequestSexAtBirthEnum
            .unknownDefaultOpenApi,
  )
  final UserHealthContextControllerUpdateUserHealthContextProfileV1RequestSexAtBirthEnum?
  sexAtBirth;
  ...
  bool operator ==(Object other) =>
      ...
      other is UserHealthContextControllerUpdateUserHealthContextProfileV1Request &&
          other.locale == locale &&
  ...
  factory UserHealthContextControllerUpdateUserHealthContextProfileV1Request.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$UserHealthContextControllerUpdateUserHealthContextProfileV1RequestFromJson(
        json,
      );

  Map<String, dynamic> toJson() =>
      _$UserHealthContextControllerUpdateUserHealthContextProfileV1RequestToJson(
        this,
      );
...
/// Preferred unit system. Use null to clear.
enum UserHealthContextControllerUpdateUserHealthContextProfileV1RequestUnitSystemEnum {
  @JsonValue(r'metric')
  metric(r'metric'),
  ...
  const UserHealthContextControllerUpdateUserHealthContextProfileV1RequestUnitSystemEnum(
    this.value,
  );
...
/// Sex assigned at birth. Use null to clear.
enum UserHealthContextControllerUpdateUserHealthContextProfileV1RequestSexAtBirthEnum {
  @JsonValue(r'female')
  female(r'female'),
  @JsonValue(r'male')
  male(r'male'),
  ...
  const UserHealthContextControllerUpdateUserHealthContextProfileV1RequestSexAtBirthEnum(
    this.value,
  );
