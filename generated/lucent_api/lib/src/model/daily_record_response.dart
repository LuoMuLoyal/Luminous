...
part 'daily_record_response.g.dart';
...
class DailyRecordResponse {
  /// Returns a new [DailyRecordResponse] instance.
  DailyRecordResponse({
    required this.id,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: DailyRecordResponseKindEnum.unknownDefaultOpenApi,
  )
  final DailyRecordResponseKindEnum kind;
  ...
  @JsonKey(
    ...
    includeIfNull: true,
    unknownEnumValue:
        DailyRecordResponseMealCalorieBucketEnum.unknownDefaultOpenApi,
  )
  final DailyRecordResponseMealCalorieBucketEnum? mealCalorieBucket;

  @JsonKey(name: r'attachments', required: true, includeIfNull: false)
  final List<DailyRecordResponseAttachments> attachments;
  ...
  factory DailyRecordResponse.fromJson(Map<String, dynamic> json) =>
      _$DailyRecordResponseFromJson(json);

  Map<String, dynamic> toJson() => _$DailyRecordResponseToJson(this);
...
enum DailyRecordResponseKindEnum {
  @JsonValue(r'water')
  water(r'water'),
  @JsonValue(r'meal')
  meal(r'meal'),
  ...
  const DailyRecordResponseKindEnum(this.value);
...
/// Coarse energy bucket derived from the interval.
enum DailyRecordResponseMealCalorieBucketEnum {
  @JsonValue(r'low')
  low(r'low'),
  @JsonValue(r'medium')
  medium(r'medium'),
  ...
  const DailyRecordResponseMealCalorieBucketEnum(this.value);
