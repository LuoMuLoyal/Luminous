...
part 'reports_controller_share_clinic_summary_v1_request.g.dart';
...
class ReportsControllerShareClinicSummaryV1Request {
  /// Returns a new [ReportsControllerShareClinicSummaryV1Request] instance.
  ...
  final List<ReportsControllerShareClinicSummaryV1RequestSelectedFieldsEnum>?
  selectedFields;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ReportsControllerShareClinicSummaryV1Request &&
  ...
  factory ReportsControllerShareClinicSummaryV1Request.fromJson(
    Map<String, dynamic> json,
  ) => _$ReportsControllerShareClinicSummaryV1RequestFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ReportsControllerShareClinicSummaryV1RequestToJson(this);
...
enum ReportsControllerShareClinicSummaryV1RequestSelectedFieldsEnum {
  ...
  const ReportsControllerShareClinicSummaryV1RequestSelectedFieldsEnum(
    this.value,
  );
