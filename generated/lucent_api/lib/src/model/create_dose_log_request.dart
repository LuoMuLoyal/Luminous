...
part 'create_dose_log_request.g.dart';
...
class CreateDoseLogRequest {
  /// Returns a new [CreateDoseLogRequest] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: CreateDoseLogRequestStatusEnum.unknownDefaultOpenApi,
  )
  final CreateDoseLogRequestStatusEnum status;
  ...
  factory CreateDoseLogRequest.fromJson(Map<String, dynamic> json) =>
      _$CreateDoseLogRequestFromJson(json);

  Map<String, dynamic> toJson() => _$CreateDoseLogRequestToJson(this);
...
enum CreateDoseLogRequestStatusEnum {
  @JsonValue(r'taken')
  taken(r'taken'),
  @JsonValue(r'skipped')
  skipped(r'skipped'),
  ...
  const CreateDoseLogRequestStatusEnum(this.value);
