...
part 'daily_record_list_response_dto_items_inner.g.dart';
...
class DailyRecordListResponseDtoItemsInner {
  /// Returns a new [DailyRecordListResponseDtoItemsInner] instance.
  DailyRecordListResponseDtoItemsInner({
    required this.id,
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        DailyRecordListResponseDtoItemsInnerKindEnum.unknownDefaultOpenApi,
  )
  final DailyRecordListResponseDtoItemsInnerKindEnum kind;
  ...
  bool operator ==(Object other) =>
      ...
      other is DailyRecordListResponseDtoItemsInner &&
          other.id == id &&
          other.kind == kind &&
  ...
  factory DailyRecordListResponseDtoItemsInner.fromJson(
    Map<String, dynamic> json,
  ) => _$DailyRecordListResponseDtoItemsInnerFromJson(json);

  Map<String, dynamic> toJson() =>
      _$DailyRecordListResponseDtoItemsInnerToJson(this);
...
enum DailyRecordListResponseDtoItemsInnerKindEnum {
  @JsonValue(r'water')
  water(r'water'),
  @JsonValue(r'meal')
  meal(r'meal'),
  ...
  const DailyRecordListResponseDtoItemsInnerKindEnum(this.value);
