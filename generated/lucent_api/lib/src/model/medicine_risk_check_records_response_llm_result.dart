...
part 'medicine_risk_check_records_response_llm_result.g.dart';
...
class MedicineRiskCheckRecordsResponseLlmResult {
  /// Returns a new [MedicineRiskCheckRecordsResponseLlmResult] instance.
  MedicineRiskCheckRecordsResponseLlmResult({
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        MedicineRiskCheckRecordsResponseLlmResultOverallRiskLevelEnum
            .unknownDefaultOpenApi,
  )
  final MedicineRiskCheckRecordsResponseLlmResultOverallRiskLevelEnum
  overallRiskLevel;
  ...
  final List<MedicineRiskCheckRecordsResponseLlmResultFindings> findings;

  /// Medicines skipped due to missing detail.
  @JsonKey(name: r'coverageIssues', required: true, includeIfNull: false)
  final List<MedicineRiskCheckRecordsResponseLlmResultCoverageIssues>
  coverageIssues;

  /// Raised red flags.
  @JsonKey(name: r'redFlags', required: true, includeIfNull: false)
  final List<MedicineRiskCheckRecordsResponseLlmResultRedFlags> redFlags;
  ...
  bool operator ==(Object other) =>
      ...
      other is MedicineRiskCheckRecordsResponseLlmResult &&
  ...
  factory MedicineRiskCheckRecordsResponseLlmResult.fromJson(
    Map<String, dynamic> json,
  ) => _$MedicineRiskCheckRecordsResponseLlmResultFromJson(json);

  Map<String, dynamic> toJson() =>
      _$MedicineRiskCheckRecordsResponseLlmResultToJson(this);
...
/// Overall risk level.
enum MedicineRiskCheckRecordsResponseLlmResultOverallRiskLevelEnum {
  @JsonValue(r'safe')
  safe(r'safe'),
  @JsonValue(r'caution')
  caution(r'caution'),
  ...
  const MedicineRiskCheckRecordsResponseLlmResultOverallRiskLevelEnum(
    this.value,
  );
