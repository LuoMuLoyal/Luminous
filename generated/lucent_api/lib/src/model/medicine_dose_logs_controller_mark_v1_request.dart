...
part 'medicine_dose_logs_controller_mark_v1_request.g.dart';
...
class MedicineDoseLogsControllerMarkV1Request {
  /// Returns a new [MedicineDoseLogsControllerMarkV1Request] instance.
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        MedicineDoseLogsControllerMarkV1RequestStatusEnum.unknownDefaultOpenApi,
  )
  final MedicineDoseLogsControllerMarkV1RequestStatusEnum status;
  ...
  bool operator ==(Object other) =>
      ...
      other is MedicineDoseLogsControllerMarkV1Request &&
  ...
  factory MedicineDoseLogsControllerMarkV1Request.fromJson(
    Map<String, dynamic> json,
  ) => _$MedicineDoseLogsControllerMarkV1RequestFromJson(json);

  Map<String, dynamic> toJson() =>
      _$MedicineDoseLogsControllerMarkV1RequestToJson(this);
...
enum MedicineDoseLogsControllerMarkV1RequestStatusEnum {
  @JsonValue(r'taken')
  taken(r'taken'),
  @JsonValue(r'skipped')
  skipped(r'skipped'),
  ...
  const MedicineDoseLogsControllerMarkV1RequestStatusEnum(this.value);
