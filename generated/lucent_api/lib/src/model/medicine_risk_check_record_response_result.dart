...
part 'medicine_risk_check_record_response_result.g.dart';
...
class MedicineRiskCheckRecordResponseResult {
  /// Returns a new [MedicineRiskCheckRecordResponseResult] instance.
  MedicineRiskCheckRecordResponseResult({
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: MedicineRiskCheckRecordResponseResultOverallRiskLevelEnum
        .unknownDefaultOpenApi,
  )
  final MedicineRiskCheckRecordResponseResultOverallRiskLevelEnum
  overallRiskLevel;
  ...
  final List<MedicineRiskCheckRecordResponseResultFindings> findings;

  /// Medicines skipped due to missing detail.
  @JsonKey(name: r'coverageIssues', required: true, includeIfNull: false)
  final List<MedicineRiskCheckRecordResponseResultCoverageIssues>
  coverageIssues;

  /// Raised red flags.
  @JsonKey(name: r'redFlags', required: true, includeIfNull: false)
  final List<MedicineRiskCheckRecordResponseResultRedFlags> redFlags;
  ...
  bool operator ==(Object other) =>
      ...
      other is MedicineRiskCheckRecordResponseResult &&
  ...
  factory MedicineRiskCheckRecordResponseResult.fromJson(
    Map<String, dynamic> json,
  ) => _$MedicineRiskCheckRecordResponseResultFromJson(json);

  Map<String, dynamic> toJson() =>
      _$MedicineRiskCheckRecordResponseResultToJson(this);
...
/// Overall risk level.
enum MedicineRiskCheckRecordResponseResultOverallRiskLevelEnum {
  @JsonValue(r'safe')
  safe(r'safe'),
  @JsonValue(r'caution')
  caution(r'caution'),
  ...
  const MedicineRiskCheckRecordResponseResultOverallRiskLevelEnum(this.value);
