...
part 'health_context_response_dto_current_medicines_inner.g.dart';
...
class HealthContextResponseDtoCurrentMedicinesInner {
  /// Returns a new [HealthContextResponseDtoCurrentMedicinesInner] instance.
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: HealthContextResponseDtoCurrentMedicinesInnerSource_Enum
        .unknownDefaultOpenApi,
  )
  final HealthContextResponseDtoCurrentMedicinesInnerSource_Enum source_;
  ...
  bool operator ==(Object other) =>
      ...
      other is HealthContextResponseDtoCurrentMedicinesInner &&
          other.id == id &&
  ...
  factory HealthContextResponseDtoCurrentMedicinesInner.fromJson(
    Map<String, dynamic> json,
  ) => _$HealthContextResponseDtoCurrentMedicinesInnerFromJson(json);

  Map<String, dynamic> toJson() =>
      _$HealthContextResponseDtoCurrentMedicinesInnerToJson(this);
...
/// Upstream source used to anchor this medicine.
enum HealthContextResponseDtoCurrentMedicinesInnerSource_Enum {
  ...
  const HealthContextResponseDtoCurrentMedicinesInnerSource_Enum(this.value);
