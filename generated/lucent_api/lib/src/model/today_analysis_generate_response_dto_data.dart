...
part 'today_analysis_generate_response_dto_data.g.dart';
...
class TodayAnalysisGenerateResponseDtoData {
  /// Returns a new [TodayAnalysisGenerateResponseDtoData] instance.
  TodayAnalysisGenerateResponseDtoData({
    required this.date,
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        TodayAnalysisGenerateResponseDtoDataStatusEnum.unknownDefaultOpenApi,
  )
  final TodayAnalysisGenerateResponseDtoDataStatusEnum status;
  ...
  bool operator ==(Object other) =>
      ...
      other is TodayAnalysisGenerateResponseDtoData &&
          other.date == date &&
  ...
  factory TodayAnalysisGenerateResponseDtoData.fromJson(
    Map<String, dynamic> json,
  ) => _$TodayAnalysisGenerateResponseDtoDataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$TodayAnalysisGenerateResponseDtoDataToJson(this);
...
enum TodayAnalysisGenerateResponseDtoDataStatusEnum {
  @JsonValue(r'empty')
  empty(r'empty'),
  @JsonValue(r'pending')
  pending(r'pending'),
  ...
  const TodayAnalysisGenerateResponseDtoDataStatusEnum(this.value);
