...
part 'record_receipt_request.g.dart';
...
class RecordReceiptRequest {
  /// Returns a new [RecordReceiptRequest] instance.
  ...
  factory RecordReceiptRequest.fromJson(Map<String, dynamic> json) =>
      _$RecordReceiptRequestFromJson(json);

  Map<String, dynamic> toJson() => _$RecordReceiptRequestToJson(this);
