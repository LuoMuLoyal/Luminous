...
class FunnelTotalsDto {
  /// Returns a new [FunnelTotalsDto] instance.
  FunnelTotalsDto({
  ...
  factory FunnelTotalsDto.fromJson(Map<String, dynamic> json) =>
      _$FunnelTotalsDtoFromJson(json);

  Map<String, dynamic> toJson() => _$FunnelTotalsDtoToJson(this);
