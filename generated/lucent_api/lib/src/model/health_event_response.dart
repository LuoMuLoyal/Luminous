...
part 'health_event_response.g.dart';
...
class HealthEventResponse {
  /// Returns a new [HealthEventResponse] instance.
  HealthEventResponse({
    required this.kind,
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: HealthEventResponseKindEnum.unknownDefaultOpenApi,
  )
  final HealthEventResponseKindEnum kind;
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: false,
    unknownEnumValue: HealthEventResponseStatusEnum.unknownDefaultOpenApi,
  )
  final HealthEventResponseStatusEnum status;
  ...
  @JsonKey(
    ...
    required: true,
    includeIfNull: true,
    unknownEnumValue: HealthEventResponseOutcomeEnum.unknownDefaultOpenApi,
  )
  final HealthEventResponseOutcomeEnum? outcome;
  ...
  final HealthEventResponseCheckIn? checkIn;

  @JsonKey(name: r'coverage', required: true, includeIfNull: false)
  final HealthEventResponseCoverage coverage;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is HealthEventResponse &&
          other.kind == kind &&
          other.id == id &&
          other.title == title &&
          other.status == status &&
  ...
  factory HealthEventResponse.fromJson(Map<String, dynamic> json) =>
      _$HealthEventResponseFromJson(json);

  Map<String, dynamic> toJson() => _$HealthEventResponseToJson(this);
...
enum HealthEventResponseKindEnum {
  @JsonValue(r'symptom')
  symptom(r'symptom'),
  @JsonValue(r'other')
  other(r'other'),
  ...
  const HealthEventResponseKindEnum(this.value);
...
enum HealthEventResponseStatusEnum {
  @JsonValue(r'active')
  active(r'active'),
  @JsonValue(r'ended')
  ended(r'ended'),
  ...
  const HealthEventResponseStatusEnum(this.value);
...
enum HealthEventResponseOutcomeEnum {
  ...
  const HealthEventResponseOutcomeEnum(this.value);
