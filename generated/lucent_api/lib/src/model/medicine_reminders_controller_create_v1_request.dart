...
part 'medicine_reminders_controller_create_v1_request.g.dart';
...
class MedicineRemindersControllerCreateV1Request {
  /// Returns a new [MedicineRemindersControllerCreateV1Request] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is MedicineRemindersControllerCreateV1Request &&
  ...
  factory MedicineRemindersControllerCreateV1Request.fromJson(
    Map<String, dynamic> json,
  ) => _$MedicineRemindersControllerCreateV1RequestFromJson(json);

  Map<String, dynamic> toJson() =>
      _$MedicineRemindersControllerCreateV1RequestToJson(this);
