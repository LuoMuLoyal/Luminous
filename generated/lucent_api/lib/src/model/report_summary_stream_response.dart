...
part 'report_summary_stream_response.g.dart';
...
class ReportSummaryStreamResponse {
  /// Returns a new [ReportSummaryStreamResponse] instance.
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        ReportSummaryStreamResponseRangeEnum.unknownDefaultOpenApi,
  )
  final ReportSummaryStreamResponseRangeEnum range;
  ...
  final ReportSummaryStreamResponseCoverage coverage;

  @JsonKey(name: r'observedPattern', required: true, includeIfNull: true)
  final ReportSummaryStreamResponseObservedPattern? observedPattern;

  @JsonKey(name: r'lowRiskAction', required: true, includeIfNull: true)
  final ReportSummaryStreamResponseLowRiskAction? lowRiskAction;
  ...
  bool operator ==(Object other) =>
      ...
      other is ReportSummaryStreamResponse &&
          other.range == range &&
  ...
  factory ReportSummaryStreamResponse.fromJson(Map<String, dynamic> json) =>
      _$ReportSummaryStreamResponseFromJson(json);

  Map<String, dynamic> toJson() => _$ReportSummaryStreamResponseToJson(this);
...
enum ReportSummaryStreamResponseRangeEnum {
  ...
  const ReportSummaryStreamResponseRangeEnum(this.value);
