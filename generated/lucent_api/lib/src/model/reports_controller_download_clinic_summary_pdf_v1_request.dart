...
part 'reports_controller_download_clinic_summary_pdf_v1_request.g.dart';
...
class ReportsControllerDownloadClinicSummaryPdfV1Request {
  /// Returns a new [ReportsControllerDownloadClinicSummaryPdfV1Request] instance.
  ...
  final List<
    ReportsControllerDownloadClinicSummaryPdfV1RequestSelectedFieldsEnum
  >?
  selectedFields;
  ...
  bool operator ==(Object other) =>
      ...
      other is ReportsControllerDownloadClinicSummaryPdfV1Request &&
  ...
  factory ReportsControllerDownloadClinicSummaryPdfV1Request.fromJson(
    Map<String, dynamic> json,
  ) => _$ReportsControllerDownloadClinicSummaryPdfV1RequestFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ReportsControllerDownloadClinicSummaryPdfV1RequestToJson(this);
...
enum ReportsControllerDownloadClinicSummaryPdfV1RequestSelectedFieldsEnum {
  ...
  const ReportsControllerDownloadClinicSummaryPdfV1RequestSelectedFieldsEnum(
    this.value,
  );
