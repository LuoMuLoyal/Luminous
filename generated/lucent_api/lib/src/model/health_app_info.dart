...
class HealthAppInfo {
  /// Returns a new [HealthAppInfo] instance.
  HealthAppInfo({
    required this.name,
  ...
  factory HealthAppInfo.fromJson(Map<String, dynamic> json) =>
      _$HealthAppInfoFromJson(json);

  Map<String, dynamic> toJson() => _$HealthAppInfoToJson(this);
