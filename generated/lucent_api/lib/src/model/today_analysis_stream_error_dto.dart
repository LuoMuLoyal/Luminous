...
class TodayAnalysisStreamErrorDto {
  ...
  @JsonKey(
    ...
    includeIfNull: false,
    unknownEnumValue:
        TodayAnalysisStreamErrorDtoStatusEnum.unknownDefaultOpenApi,
  )
  final TodayAnalysisStreamErrorDtoStatusEnum status;
...
/// Why the stream ended; this is not an HTTP status code.
enum TodayAnalysisStreamErrorDtoStatusEnum {
  /// Why the stream ended; this is not an HTTP status code.
  ...
  const TodayAnalysisStreamErrorDtoStatusEnum(this.value);
