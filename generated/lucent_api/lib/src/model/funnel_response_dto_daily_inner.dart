...
part 'funnel_response_dto_daily_inner.g.dart';
...
class FunnelResponseDtoDailyInner {
  /// Returns a new [FunnelResponseDtoDailyInner] instance.
  FunnelResponseDtoDailyInner({
    required this.date,
  ...
  bool operator ==(Object other) =>
      ...
      other is FunnelResponseDtoDailyInner &&
          other.date == date &&
  ...
  factory FunnelResponseDtoDailyInner.fromJson(Map<String, dynamic> json) =>
      _$FunnelResponseDtoDailyInnerFromJson(json);

  Map<String, dynamic> toJson() => _$FunnelResponseDtoDailyInnerToJson(this);
