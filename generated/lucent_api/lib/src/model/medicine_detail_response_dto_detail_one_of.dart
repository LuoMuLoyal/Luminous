...
part 'medicine_detail_response_dto_detail_one_of.g.dart';
...
class MedicineDetailResponseDtoDetailOneOf {
  /// Returns a new [MedicineDetailResponseDtoDetailOneOf] instance.
  MedicineDetailResponseDtoDetailOneOf({
    required this.kind,
  ...
  bool operator ==(Object other) =>
      ...
      other is MedicineDetailResponseDtoDetailOneOf &&
          other.kind == kind &&
  ...
  factory MedicineDetailResponseDtoDetailOneOf.fromJson(
    Map<String, dynamic> json,
  ) => _$MedicineDetailResponseDtoDetailOneOfFromJson(json);

  Map<String, dynamic> toJson() =>
      _$MedicineDetailResponseDtoDetailOneOfToJson(this);
