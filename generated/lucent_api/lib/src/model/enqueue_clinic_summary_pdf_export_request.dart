...
part 'enqueue_clinic_summary_pdf_export_request.g.dart';
...
class EnqueueClinicSummaryPdfExportRequest {
  /// Returns a new [EnqueueClinicSummaryPdfExportRequest] instance.
  ...
  final List<EnqueueClinicSummaryPdfExportRequestSelectedFieldsEnum>?
  selectedFields;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is EnqueueClinicSummaryPdfExportRequest &&
  ...
  factory EnqueueClinicSummaryPdfExportRequest.fromJson(
    Map<String, dynamic> json,
  ) => _$EnqueueClinicSummaryPdfExportRequestFromJson(json);

  Map<String, dynamic> toJson() =>
      _$EnqueueClinicSummaryPdfExportRequestToJson(this);
...
enum EnqueueClinicSummaryPdfExportRequestSelectedFieldsEnum {
  ...
  const EnqueueClinicSummaryPdfExportRequestSelectedFieldsEnum(this.value);
