...
import 'package:lucent_api/src/api/health_events_api.dart';
...
import 'package:lucent_api/src/api/notification_preferences_api.dart';
...
class LucentApi {
  ...
  /// Get HealthEventsApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  HealthEventsApi getHealthEventsApi() {
    return HealthEventsApi(dio);
  }
  ...
  NotificationPreferencesApi getNotificationPreferencesApi() {
    return NotificationPreferencesApi(dio);
  }
  ...
  /// Get ProductEventsApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  ProductEventsApi getProductEventsApi() {
    return ProductEventsApi(dio);
  }
